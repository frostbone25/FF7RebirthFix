...
#include "btsc_COMMON_VRTurks_classes.hpp"
#include "btsc_COMMON_VRTurks_parameters.hpp"
...
void Abtsc_COMMON_VRTurks_C::ExecuteUbergraph_btsc_COMMON_VRTurks(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_COMMON_VRTurks_C", "ExecuteUbergraph_btsc_COMMON_VRTurks");

	Params::btsc_COMMON_VRTurks_C_ExecuteUbergraph_btsc_COMMON_VRTurks Parms{};
...
void Abtsc_COMMON_VRTurks_C::OnEntryBattleScene(const class FName& battleScenenBPName, const class FName& territoryID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_COMMON_VRTurks_C", "OnEntryBattleScene");

	Params::btsc_COMMON_VRTurks_C_OnEntryBattleScene Parms{};
...
void Abtsc_COMMON_VRTurks_C::OnBattleTalkEnded(class FName TalkID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_COMMON_VRTurks_C", "OnBattleTalkEnded");

	Params::btsc_COMMON_VRTurks_C_OnBattleTalkEnded Parms{};
...
// Function btsc_COMMON_VRTurks.btsc_COMMON_VRTurks_C.OnPostEntryBattleScene
// (Event, Public, BlueprintEvent)

void Abtsc_COMMON_VRTurks_C::OnPostEntryBattleScene()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_COMMON_VRTurks_C", "OnPostEntryBattleScene");
