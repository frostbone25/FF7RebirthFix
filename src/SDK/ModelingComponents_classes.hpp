...
{
public:
	class UMaterialInterface*                     LineMaterial;                                      // 0x0510(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FBoxSphereBounds                       bounds;                                            // 0x0518(0x001C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	bool                                          bBoundsDirty;                                      // 0x0534(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_535[0x3B];                                     // 0x0535(0x003B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULineSetComponent) == 0x000570, "Wrong size on ULineSetComponent");
static_assert(offsetof(ULineSetComponent, LineMaterial) == 0x000510, "Member 'ULineSetComponent::LineMaterial' has a wrong offset!");
static_assert(offsetof(ULineSetComponent, bounds) == 0x000518, "Member 'ULineSetComponent::bounds' has a wrong offset!");
static_assert(offsetof(ULineSetComponent, bBoundsDirty) == 0x000534, "Member 'ULineSetComponent::bBoundsDirty' has a wrong offset!");
...
public:
	...
	bool                                          bExplicitShowWireframe;                            // 0x0570(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_571[0xFF];                                     // 0x0571(0x00FF)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UOctreeDynamicMeshComponent) == 0x000670, "Wrong size on UOctreeDynamicMeshComponent");
static_assert(offsetof(UOctreeDynamicMeshComponent, bExplicitShowWireframe) == 0x000570, "Member 'UOctreeDynamicMeshComponent::bExplicitShowWireframe' has a wrong offset!");
...
{
public:
	uint8                                         Pad_30[0x480];                                     // 0x0030(0x0480)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPlaneDistanceFromHitMechanic) == 0x0004B0, "Wrong size on UPlaneDistanceFromHitMechanic");
...
{
public:
	class UMaterialInterface*                     PointMaterial;                                     // 0x0510(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FBoxSphereBounds                       bounds;                                            // 0x0518(0x001C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	bool                                          bBoundsDirty;                                      // 0x0534(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_535[0x3B];                                     // 0x0535(0x003B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPointSetComponent) == 0x000570, "Wrong size on UPointSetComponent");
static_assert(offsetof(UPointSetComponent, PointMaterial) == 0x000510, "Member 'UPointSetComponent::PointMaterial' has a wrong offset!");
static_assert(offsetof(UPointSetComponent, bounds) == 0x000518, "Member 'UPointSetComponent::bounds' has a wrong offset!");
static_assert(offsetof(UPointSetComponent, bBoundsDirty) == 0x000534, "Member 'UPointSetComponent::bBoundsDirty' has a wrong offset!");
...
static_assert(offsetof(UPolygonSelectionMechanicProperties, bPreferProjectedElement) == 0x000063, "Member 'UPolygonSelectionMechanicProperties::bPreferProjectedElement' has a wrong offset!");
static_assert(offsetof(UPolygonSelectionMechanicProperties, bSelectDownRay) == 0x000064, "Member 'UPolygonSelectionMechanicProperties::bSelectDownRay' has a wrong offset!");
static_assert(offsetof(UPolygonSelectionMechanicProperties, bIgnoreOcclusion) == 0x000065, "Member 'UPolygonSelectionMechanicProperties::bIgnoreOcclusion' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_58[0x308];                                     // 0x0058(0x0308)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3C8[0x2A8];                                    // 0x03C8(0x02A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPolygonSelectionMechanic) == 0x000670, "Wrong size on UPolygonSelectionMechanic");
...
static_assert(offsetof(UPolygonSelectionMechanic, PreviewGeometryActor) == 0x000360, "Member 'UPolygonSelectionMechanic::PreviewGeometryActor' has a wrong offset!");
static_assert(offsetof(UPolygonSelectionMechanic, DrawnTriangleSetComponent) == 0x000368, "Member 'UPolygonSelectionMechanic::DrawnTriangleSetComponent' has a wrong offset!");
static_assert(offsetof(UPolygonSelectionMechanic, HighlightedFaceMaterial) == 0x0003C0, "Member 'UPolygonSelectionMechanic::HighlightedFaceMaterial' has a wrong offset!");
...
static_assert(sizeof(APreviewGeometryActor) == 0x000228, "Wrong size on APreviewGeometryActor");
...
static_assert(sizeof(APreviewMeshActor) == 0x000228, "Wrong size on APreviewMeshActor");
...
{
public:
	EDynamicMeshTangentCalcType                   TangentsType;                                      // 0x0558(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bInvalidateProxyOnChange;                          // 0x0559(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_55A[0x36];                                     // 0x055A(0x0036)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bExplicitShowWireframe;                            // 0x0590(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_591[0x4F];                                     // 0x0591(0x004F)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bDrawOnTop;                                        // 0x05E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USimpleDynamicMeshComponent) == 0x0006B0, "Wrong size on USimpleDynamicMeshComponent");
static_assert(offsetof(USimpleDynamicMeshComponent, TangentsType) == 0x000558, "Member 'USimpleDynamicMeshComponent::TangentsType' has a wrong offset!");
static_assert(offsetof(USimpleDynamicMeshComponent, bInvalidateProxyOnChange) == 0x000559, "Member 'USimpleDynamicMeshComponent::bInvalidateProxyOnChange' has a wrong offset!");
static_assert(offsetof(USimpleDynamicMeshComponent, bExplicitShowWireframe) == 0x000590, "Member 'USimpleDynamicMeshComponent::bExplicitShowWireframe' has a wrong offset!");
static_assert(offsetof(USimpleDynamicMeshComponent, bDrawOnTop) == 0x0005E0, "Member 'USimpleDynamicMeshComponent::bDrawOnTop' has a wrong offset!");
...
{
public:
	struct FBoxSphereBounds                       bounds;                                            // 0x0510(0x001C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	bool                                          bBoundsDirty;                                      // 0x052C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_52D[0xC3];                                     // 0x052D(0x00C3)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UTriangleSetComponent) == 0x0005F0, "Wrong size on UTriangleSetComponent");
static_assert(offsetof(UTriangleSetComponent, bounds) == 0x000510, "Member 'UTriangleSetComponent::bounds' has a wrong offset!");
static_assert(offsetof(UTriangleSetComponent, bBoundsDirty) == 0x00052C, "Member 'UTriangleSetComponent::bBoundsDirty' has a wrong offset!");
