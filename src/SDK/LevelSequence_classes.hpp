...
public:
	...
	class ULevelSequence* GetSequence(class FName LevelName) const;
...
// 0x0160 (0x07F0 - 0x0690)
class alignas(0x10) ULevelSequencePlayer : public UMovieSceneSequencePlayer
{
public:
	TMulticastInlineDelegate<void(class UCameraComponent* CameraComponent)> OnCameraCut;                                       // 0x0690(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULevelSequencePlayer) == 0x0007F0, "Wrong size on ULevelSequencePlayer");
static_assert(offsetof(ULevelSequencePlayer, OnCameraCut) == 0x000690, "Member 'ULevelSequencePlayer::OnCameraCut' has a wrong offset!");
