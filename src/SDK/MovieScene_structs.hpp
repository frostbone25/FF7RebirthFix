...
static_assert(offsetof(FMovieSceneSubSequenceData, bHasHierarchicalEasing) == 0x000096, "Member 'FMovieSceneSubSequenceData::bHasHierarchicalEasing' has a wrong offset!");
