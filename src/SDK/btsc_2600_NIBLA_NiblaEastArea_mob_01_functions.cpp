...
#include "btsc_2600_NIBLA_NiblaEastArea_mob_01_classes.hpp"
#include "btsc_2600_NIBLA_NiblaEastArea_mob_01_parameters.hpp"
...
void Abtsc_2600_NIBLA_NiblaEastArea_mob_01_C::ExecuteUbergraph_btsc_2600_NIBLA_NiblaEastArea_mob_01(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_2600-NIBLA_NiblaEastArea_mob_01_C", "ExecuteUbergraph_btsc_2600-NIBLA_NiblaEastArea_mob_01");

	Params::btsc_2600_NIBLA_NiblaEastArea_mob_01_C_ExecuteUbergraph_btsc_2600_NIBLA_NiblaEastArea_mob_01 Parms{};
...
void Abtsc_2600_NIBLA_NiblaEastArea_mob_01_C::OnTakeDamage(int32 Damage, const class FName& CauserCharaName, const class FName& DamagedCharaName, const class FName& AbilityId, bool bBind, bool bGuard, const class FName& hitBoneName, bool bAttributeHit, bool bResistHit, const class FName& DamageSourceID, EEndBattleAttributeType appendAttribute, float justHitRotYaw, const struct FVector& hitPosition, bool bHeal, bool bBurst, bool bLock)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_2600-NIBLA_NiblaEastArea_mob_01_C", "OnTakeDamage");

	Params::btsc_2600_NIBLA_NiblaEastArea_mob_01_C_OnTakeDamage Parms{};
...
void Abtsc_2600_NIBLA_NiblaEastArea_mob_01_C::OnEntryBattleScene(const class FName& battleScenenBPName, const class FName& territoryID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_2600-NIBLA_NiblaEastArea_mob_01_C", "OnEntryBattleScene");

	Params::btsc_2600_NIBLA_NiblaEastArea_mob_01_C_OnEntryBattleScene Parms{};
