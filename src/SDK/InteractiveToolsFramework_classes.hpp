...
public:
	...
	struct FBrushStampData                        LastBrushStamp;                                    // 0x00D0(0x00B0)(NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBaseBrushTool) == 0x0001C0, "Wrong size on UBaseBrushTool");
...
static_assert(offsetof(UBaseBrushTool, PropertyClass) == 0x000190, "Member 'UBaseBrushTool::PropertyClass' has a wrong offset!");
static_assert(offsetof(UBaseBrushTool, BrushStampIndicator) == 0x0001B8, "Member 'UBaseBrushTool::BrushStampIndicator' has a wrong offset!");
