...
static_assert(sizeof(UMovieSceneNiagaraTrack) == 0x000088, "Wrong size on UMovieSceneNiagaraTrack");
static_assert(offsetof(UMovieSceneNiagaraTrack, Sections) == 0x000078, "Member 'UMovieSceneNiagaraTrack::Sections' has a wrong offset!");
...
public:
	...
	uint8                                         VfxSubImage : 1;                                   // 0x00CC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         VfxSubImageRepeat : 1;                             // 0x00CC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         VfxMaterialResident : 1;                           // 0x00CC(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         VfxMaterialEmit : 1;                               // 0x00CC(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         VfxMaterialOpaque : 1;                             // 0x00CC(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         VfxMaterialChara : 1;                              // 0x00CC(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         VfxMaterialOrthographic : 1;                       // 0x00CC(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         VfxMaterialGlare : 1;                              // 0x00CC(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         VfxMaterialBlur : 1;                               // 0x00CD(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         VfxOverrideCullMode : 1;                           // 0x00CD(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_CE[0x2];                                       // 0x00CE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	EVfxCullModeKind                              VfxCullMode;                                       // 0x00D0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D1[0x3];                                       // 0x00D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         VfxOverride_ExtraRenderPass : 1;                   // 0x00D4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_D5[0x3];                                       // 0x00D5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	EVfxExtraRenderPass                           VfxExtraRenderPass;                                // 0x00D8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D9[0x3];                                       // 0x00D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         VfxBillBoardParticleLocation : 1;                  // 0x00DC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         VfxParticleLocationToOrthographicSpace : 1;        // 0x00DC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_DD[0x3];                                       // 0x00DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	EVfxParticleFadeDistancePreset                VfxParticleFadeDistancePreset;                     // 0x00E0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EVfxMaterialVABKind                           VfxMaterialVABKind;                                // 0x00E1(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E2[0x6];                                       // 0x00E2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableAttributeBinding       VfxMaterialIndependentParameters0_Binding;         // 0x00E8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VfxMaterialIndependentParameters1_Binding;         // 0x0140(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VfxMaterialIndependentParameters2_Binding;         // 0x0198(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VfxMaterialIndependentParameters3_Binding;         // 0x01F0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VfxMaterialIndependentParameters4_Binding;         // 0x0248(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VfxMaterialIndependentParameters5_Binding;         // 0x02A0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VfxMaterialIndependentParameters6_Binding;         // 0x02F8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VfxMaterialIndependentParameters7_Binding;         // 0x0350(0x0058)(Edit, NativeAccessSpecifierPublic)
	bool                                          bMotionBlurEnabled;                                // 0x03A8(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UNiagaraRendererProperties) == 0x0003C0, "Wrong size on UNiagaraRendererProperties");
...
static_assert(offsetof(UNiagaraRendererProperties, VfxCullMode) == 0x0000D0, "Member 'UNiagaraRendererProperties::VfxCullMode' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, VfxExtraRenderPass) == 0x0000D8, "Member 'UNiagaraRendererProperties::VfxExtraRenderPass' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, VfxParticleFadeDistancePreset) == 0x0000E0, "Member 'UNiagaraRendererProperties::VfxParticleFadeDistancePreset' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, VfxMaterialVABKind) == 0x0000E1, "Member 'UNiagaraRendererProperties::VfxMaterialVABKind' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, VfxMaterialIndependentParameters0_Binding) == 0x0000E8, "Member 'UNiagaraRendererProperties::VfxMaterialIndependentParameters0_Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, VfxMaterialIndependentParameters1_Binding) == 0x000140, "Member 'UNiagaraRendererProperties::VfxMaterialIndependentParameters1_Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, VfxMaterialIndependentParameters2_Binding) == 0x000198, "Member 'UNiagaraRendererProperties::VfxMaterialIndependentParameters2_Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, VfxMaterialIndependentParameters3_Binding) == 0x0001F0, "Member 'UNiagaraRendererProperties::VfxMaterialIndependentParameters3_Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, VfxMaterialIndependentParameters4_Binding) == 0x000248, "Member 'UNiagaraRendererProperties::VfxMaterialIndependentParameters4_Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, VfxMaterialIndependentParameters5_Binding) == 0x0002A0, "Member 'UNiagaraRendererProperties::VfxMaterialIndependentParameters5_Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, VfxMaterialIndependentParameters6_Binding) == 0x0002F8, "Member 'UNiagaraRendererProperties::VfxMaterialIndependentParameters6_Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, VfxMaterialIndependentParameters7_Binding) == 0x000350, "Member 'UNiagaraRendererProperties::VfxMaterialIndependentParameters7_Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, bMotionBlurEnabled) == 0x0003A8, "Member 'UNiagaraRendererProperties::bMotionBlurEnabled' has a wrong offset!");

// Class Niagara.NiagaraSpriteRendererProperties
// 0x08E8 (0x0CA8 - 0x03C0)
class UNiagaraSpriteRendererProperties final : public UNiagaraRendererProperties
{
public:
	class UMaterialInterface*                     Material;                                          // 0x03C0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraRendererSourceDataMode                SourceMode;                                        // 0x03C8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3C9[0x7];                                      // 0x03C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraUserParameterBinding           MaterialUserParamBinding;                          // 0x03D0(0x0020)(Edit, NativeAccessSpecifierPublic)
	ENiagaraSpriteAlignment                       Alignment;                                         // 0x03F0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraSpriteFacingMode                      FacingMode;                                        // 0x03F1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3F2[0x2];                                      // 0x03F2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              PivotInUVSpace;                                    // 0x03F4(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MacroUVRadius;                                     // 0x03FC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraSortMode                              SortMode;                                          // 0x0400(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_401[0x3];                                      // 0x0401(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              SubImageSize;                                      // 0x0404(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bSubImageBlend : 1;                                // 0x040C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRemoveHMDRollInVR : 1;                            // 0x040C(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSortOnlyWhenTranslucent : 1;                      // 0x040C(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_40D[0x3];                                      // 0x040D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	ENiagaraRendererSortPrecision                 SortPrecision;                                     // 0x0410(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_411[0x3];                                      // 0x0411(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bGpuLowLatencyTranslucency : 1;                    // 0x0414(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_415[0x3];                                      // 0x0415(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinFacingCameraBlendDistance;                      // 0x0418(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxFacingCameraBlendDistance;                      // 0x041C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bEnableCameraDistanceCulling : 1;                  // 0x0420(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_421[0x3];                                      // 0x0421(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinCameraDistance;                                 // 0x0424(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxCameraDistance;                                 // 0x0428(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        RendererVisibility;                                // 0x042C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PositionBinding;                                   // 0x0430(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       ColorBinding;                                      // 0x0488(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VelocityBinding;                                   // 0x04E0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SpriteRotationBinding;                             // 0x0538(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SpriteSizeBinding;                                 // 0x0590(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SpriteFacingBinding;                               // 0x05E8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SpriteAlignmentBinding;                            // 0x0640(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SubImageIndexBinding;                              // 0x0698(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       CameraOffsetBinding;                               // 0x06F0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       UVScaleBinding;                                    // 0x0748(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PivotOffsetBinding;                                // 0x07A0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MaterialRandomBinding;                             // 0x07F8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       CustomSortingBinding;                              // 0x0850(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       NormalizedAgeBinding;                              // 0x08A8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0900(0x0058)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraMaterialAttributeBinding> MaterialParameterBindings;                         // 0x0958(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         VfxLensFlare : 1;                                  // 0x0968(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_969[0x7];                                      // 0x0969(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableAttributeBinding       PrevPositionBinding;                               // 0x0970(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevVelocityBinding;                               // 0x09C8(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevSpriteRotationBinding;                         // 0x0A20(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevSpriteSizeBinding;                             // 0x0A78(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevSpriteFacingBinding;                           // 0x0AD0(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevSpriteAlignmentBinding;                        // 0x0B28(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevCameraOffsetBinding;                           // 0x0B80(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevPivotOffsetBinding;                            // 0x0BD8(0x0058)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_C30[0x78];                                     // 0x0C30(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraSpriteRendererProperties) == 0x000CA8, "Wrong size on UNiagaraSpriteRendererProperties");
static_assert(offsetof(UNiagaraSpriteRendererProperties, Material) == 0x0003C0, "Member 'UNiagaraSpriteRendererProperties::Material' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SourceMode) == 0x0003C8, "Member 'UNiagaraSpriteRendererProperties::SourceMode' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialUserParamBinding) == 0x0003D0, "Member 'UNiagaraSpriteRendererProperties::MaterialUserParamBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, Alignment) == 0x0003F0, "Member 'UNiagaraSpriteRendererProperties::Alignment' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, FacingMode) == 0x0003F1, "Member 'UNiagaraSpriteRendererProperties::FacingMode' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PivotInUVSpace) == 0x0003F4, "Member 'UNiagaraSpriteRendererProperties::PivotInUVSpace' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MacroUVRadius) == 0x0003FC, "Member 'UNiagaraSpriteRendererProperties::MacroUVRadius' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SortMode) == 0x000400, "Member 'UNiagaraSpriteRendererProperties::SortMode' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SubImageSize) == 0x000404, "Member 'UNiagaraSpriteRendererProperties::SubImageSize' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SortPrecision) == 0x000410, "Member 'UNiagaraSpriteRendererProperties::SortPrecision' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MinFacingCameraBlendDistance) == 0x000418, "Member 'UNiagaraSpriteRendererProperties::MinFacingCameraBlendDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaxFacingCameraBlendDistance) == 0x00041C, "Member 'UNiagaraSpriteRendererProperties::MaxFacingCameraBlendDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MinCameraDistance) == 0x000424, "Member 'UNiagaraSpriteRendererProperties::MinCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaxCameraDistance) == 0x000428, "Member 'UNiagaraSpriteRendererProperties::MaxCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, RendererVisibility) == 0x00042C, "Member 'UNiagaraSpriteRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PositionBinding) == 0x000430, "Member 'UNiagaraSpriteRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, ColorBinding) == 0x000488, "Member 'UNiagaraSpriteRendererProperties::ColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, VelocityBinding) == 0x0004E0, "Member 'UNiagaraSpriteRendererProperties::VelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteRotationBinding) == 0x000538, "Member 'UNiagaraSpriteRendererProperties::SpriteRotationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteSizeBinding) == 0x000590, "Member 'UNiagaraSpriteRendererProperties::SpriteSizeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteFacingBinding) == 0x0005E8, "Member 'UNiagaraSpriteRendererProperties::SpriteFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteAlignmentBinding) == 0x000640, "Member 'UNiagaraSpriteRendererProperties::SpriteAlignmentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SubImageIndexBinding) == 0x000698, "Member 'UNiagaraSpriteRendererProperties::SubImageIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, CameraOffsetBinding) == 0x0006F0, "Member 'UNiagaraSpriteRendererProperties::CameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, UVScaleBinding) == 0x000748, "Member 'UNiagaraSpriteRendererProperties::UVScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PivotOffsetBinding) == 0x0007A0, "Member 'UNiagaraSpriteRendererProperties::PivotOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialRandomBinding) == 0x0007F8, "Member 'UNiagaraSpriteRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, CustomSortingBinding) == 0x000850, "Member 'UNiagaraSpriteRendererProperties::CustomSortingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, NormalizedAgeBinding) == 0x0008A8, "Member 'UNiagaraSpriteRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, RendererVisibilityTagBinding) == 0x000900, "Member 'UNiagaraSpriteRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialParameterBindings) == 0x000958, "Member 'UNiagaraSpriteRendererProperties::MaterialParameterBindings' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevPositionBinding) == 0x000970, "Member 'UNiagaraSpriteRendererProperties::PrevPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevVelocityBinding) == 0x0009C8, "Member 'UNiagaraSpriteRendererProperties::PrevVelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteRotationBinding) == 0x000A20, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteRotationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteSizeBinding) == 0x000A78, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteSizeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteFacingBinding) == 0x000AD0, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteAlignmentBinding) == 0x000B28, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteAlignmentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevCameraOffsetBinding) == 0x000B80, "Member 'UNiagaraSpriteRendererProperties::PrevCameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevPivotOffsetBinding) == 0x000BD8, "Member 'UNiagaraSpriteRendererProperties::PrevPivotOffsetBinding' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneNiagaraParameterTrack, Parameter) == 0x000088, "Member 'UMovieSceneNiagaraParameterTrack::Parameter' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneNiagaraBoolParameterTrack) == 0x0000B0, "Wrong size on UMovieSceneNiagaraBoolParameterTrack");
...
static_assert(sizeof(UMovieSceneNiagaraColorParameterTrack) == 0x0000B0, "Wrong size on UMovieSceneNiagaraColorParameterTrack");
...
static_assert(sizeof(UMovieSceneNiagaraFloatParameterTrack) == 0x0000B0, "Wrong size on UMovieSceneNiagaraFloatParameterTrack");
...
static_assert(sizeof(UMovieSceneNiagaraIntegerParameterTrack) == 0x0000B0, "Wrong size on UMovieSceneNiagaraIntegerParameterTrack");
...
{
public:
	ENiagaraSystemSpawnSectionStartBehavior       SectionStartBehavior;                              // 0x00A8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ENiagaraSystemSpawnSectionEvaluateBehavior    SectionEvaluateBehavior;                           // 0x00AC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ENiagaraSystemSpawnSectionEndBehavior         SectionEndBehavior;                                // 0x00B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ENiagaraAgeUpdateMode                         AgeUpdateMode;                                     // 0x00B4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bAllowScalability;                                 // 0x00B5(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneNiagaraSystemSpawnSection) == 0x0000B8, "Wrong size on UMovieSceneNiagaraSystemSpawnSection");
static_assert(offsetof(UMovieSceneNiagaraSystemSpawnSection, SectionStartBehavior) == 0x0000A8, "Member 'UMovieSceneNiagaraSystemSpawnSection::SectionStartBehavior' has a wrong offset!");
static_assert(offsetof(UMovieSceneNiagaraSystemSpawnSection, SectionEvaluateBehavior) == 0x0000AC, "Member 'UMovieSceneNiagaraSystemSpawnSection::SectionEvaluateBehavior' has a wrong offset!");
static_assert(offsetof(UMovieSceneNiagaraSystemSpawnSection, SectionEndBehavior) == 0x0000B0, "Member 'UMovieSceneNiagaraSystemSpawnSection::SectionEndBehavior' has a wrong offset!");
static_assert(offsetof(UMovieSceneNiagaraSystemSpawnSection, AgeUpdateMode) == 0x0000B4, "Member 'UMovieSceneNiagaraSystemSpawnSection::AgeUpdateMode' has a wrong offset!");
static_assert(offsetof(UMovieSceneNiagaraSystemSpawnSection, bAllowScalability) == 0x0000B5, "Member 'UMovieSceneNiagaraSystemSpawnSection::bAllowScalability' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneNiagaraSystemTrack) == 0x000090, "Wrong size on UMovieSceneNiagaraSystemTrack");
...
static_assert(sizeof(UMovieSceneNiagaraVectorParameterTrack) == 0x0000B8, "Wrong size on UMovieSceneNiagaraVectorParameterTrack");
static_assert(offsetof(UMovieSceneNiagaraVectorParameterTrack, ChannelsUsed) == 0x0000B0, "Member 'UMovieSceneNiagaraVectorParameterTrack::ChannelsUsed' has a wrong offset!");
...
{
public:
	class UNiagaraComponent*                      NiagaraComponent;                                  // 0x0228(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         bDestroyOnSystemFinish : 1;                        // 0x0230(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
{
public:
	class UNiagaraSystem*                         Asset;                                             // 0x0638(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ENiagaraTickBehavior                          TickBehavior;                                      // 0x0640(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_641[0x3];                                      // 0x0641(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         RandomSeedOffset;                                  // 0x0644(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FNiagaraUserRedirectionParameterStore  OverrideParameters;                                // 0x0648(0x00E8)(NativeAccessSpecifierPrivate)
	uint8                                         bForceSolo : 1;                                    // 0x0730(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bEnableGpuComputeDebug : 1;                        // 0x0730(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         BitPad_730_2 : 6;                                  // 0x0730(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_731[0x37];                                     // 0x0731(0x0037)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bAutoDestroy : 1;                                  // 0x0768(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bRenderingEnabled : 1;                             // 0x0768(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAutoManageAttachment : 1;                         // 0x0768(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAutoAttachWeldSimulatedBodies : 1;                // 0x0768(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_769[0x3];                                      // 0x0769(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxTimeBeforeForceUpdateTransform;                 // 0x076C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_770[0x8];                                      // 0x0770(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class UNiagaraComponent* PSystem)> OnSystemFinished;                                  // 0x0778(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class USceneComponent>         AutoAttachParent;                                  // 0x0788(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	EAttachmentRule                               AutoAttachLocationRule;                            // 0x0798(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachRotationRule;                            // 0x0799(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachScaleRule;                               // 0x079A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_79B[0xD];                                      // 0x079B(0x000D)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<uint32, class UObject*>                  m_VfxRefDataInterfaceAssetMap;                     // 0x07A8(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         m_VfxDisableLowPerformance : 1;                    // 0x07F8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         BitPad_7F8_1 : 3;                                  // 0x07F8(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bAllowScalability : 1;                             // 0x07F8(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_7F9[0xCF];                                     // 0x07F9(0x00CF)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraSimCache*                       SimCache;                                          // 0x08C8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UNiagaraCullProxyComponent*             CullProxy;                                         // 0x08D0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraComponent) == 0x0008E0, "Wrong size on UNiagaraComponent");
static_assert(offsetof(UNiagaraComponent, Asset) == 0x000638, "Member 'UNiagaraComponent::Asset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, TickBehavior) == 0x000640, "Member 'UNiagaraComponent::TickBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, RandomSeedOffset) == 0x000644, "Member 'UNiagaraComponent::RandomSeedOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x000648, "Member 'UNiagaraComponent::OverrideParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, MaxTimeBeforeForceUpdateTransform) == 0x00076C, "Member 'UNiagaraComponent::MaxTimeBeforeForceUpdateTransform' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OnSystemFinished) == 0x000778, "Member 'UNiagaraComponent::OnSystemFinished' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachParent) == 0x000788, "Member 'UNiagaraComponent::AutoAttachParent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachSocketName) == 0x000790, "Member 'UNiagaraComponent::AutoAttachSocketName' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x000798, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x000799, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x00079A, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, m_VfxRefDataInterfaceAssetMap) == 0x0007A8, "Member 'UNiagaraComponent::m_VfxRefDataInterfaceAssetMap' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, SimCache) == 0x0008C8, "Member 'UNiagaraComponent::SimCache' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, CullProxy) == 0x0008D0, "Member 'UNiagaraComponent::CullProxy' has a wrong offset!");
...
{
public:
	TSubclassOf<class USceneComponent>            ComponentType;                                     // 0x03C0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        ComponentCountLimit;                               // 0x03C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3CC[0x4];                                      // 0x03CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableAttributeBinding       EnabledBinding;                                    // 0x03D0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0428(0x0058)(Edit, NativeAccessSpecifierPublic)
	bool                                          bAssignComponentsOnParticleID;                     // 0x0480(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOnlyCreateComponentsOnParticleSpawn;              // 0x0481(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_482[0x2];                                      // 0x0482(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         RendererVisibility;                                // 0x0484(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USceneComponent*                        TemplateComponent;                                 // 0x0488(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraComponentPropertyBinding> PropertyBindings;                                  // 0x0490(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_4A0[0x60];                                     // 0x04A0(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraComponentRendererProperties) == 0x000500, "Wrong size on UNiagaraComponentRendererProperties");
static_assert(offsetof(UNiagaraComponentRendererProperties, ComponentType) == 0x0003C0, "Member 'UNiagaraComponentRendererProperties::ComponentType' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, ComponentCountLimit) == 0x0003C8, "Member 'UNiagaraComponentRendererProperties::ComponentCountLimit' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, EnabledBinding) == 0x0003D0, "Member 'UNiagaraComponentRendererProperties::EnabledBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, RendererVisibilityTagBinding) == 0x000428, "Member 'UNiagaraComponentRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, bAssignComponentsOnParticleID) == 0x000480, "Member 'UNiagaraComponentRendererProperties::bAssignComponentsOnParticleID' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, bOnlyCreateComponentsOnParticleSpawn) == 0x000481, "Member 'UNiagaraComponentRendererProperties::bOnlyCreateComponentsOnParticleSpawn' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, RendererVisibility) == 0x000484, "Member 'UNiagaraComponentRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, TemplateComponent) == 0x000488, "Member 'UNiagaraComponentRendererProperties::TemplateComponent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, PropertyBindings) == 0x000490, "Member 'UNiagaraComponentRendererProperties::PropertyBindings' has a wrong offset!");
...
{
public:
	TArray<struct FNiagaraCulledComponentInfo>    Instances;                                         // 0x08D8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraCullProxyComponent) == 0x0008F0, "Wrong size on UNiagaraCullProxyComponent");
static_assert(offsetof(UNiagaraCullProxyComponent, Instances) == 0x0008D8, "Member 'UNiagaraCullProxyComponent::Instances' has a wrong offset!");
...
public:
	...
	uint32                                        LUTOffset;                                         // 0x0058(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UNiagaraDataInterfaceCurveBase, LUTOffset) == 0x000058, "Member 'UNiagaraDataInterfaceCurveBase::LUTOffset' has a wrong offset!");
...
public:
	...
	struct FNiagaraDebugHUDSettingsData           Data;                                              // 0x0048(0x01E8)(Edit, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDebugHUDSettings) == 0x000230, "Wrong size on UNiagaraDebugHUDSettings");
...
public:
	...
	TArray<class UNiagaraValidationRule*>         ValidationRules;                                   // 0x0070(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	uint8                                         Pad_80[0x8];                                       // 0x0080(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraBaselineController*             PerformanceBaselineController;                     // 0x0088(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	bool                                          bLocalSpace;                                       // 0x0058(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDeterminism;                                      // 0x0059(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	EParticleAllocationMode                       AllocationMode;                                    // 0x0060(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x3];                                       // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PreAllocationCount;                                // 0x0064(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraEmitterScriptProperties        UpdateScriptProps;                                 // 0x0068(0x0028)(NativeAccessSpecifierPublic)
	struct FNiagaraEmitterScriptProperties        SpawnScriptProps;                                  // 0x0090(0x0028)(NativeAccessSpecifierPublic)
	ENiagaraSimTarget                             SimTarget;                                         // 0x00B8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B9[0x3];                                       // 0x00B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FBox                                   FixedBounds;                                       // 0x00BC(0x001C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         MinDetailLevel;                                    // 0x00D8(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MaxDetailLevel;                                    // 0x00DC(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraDetailsLevelScaleOverrides     GlobalSpawnCountScaleOverrides;                    // 0x00E0(0x0014)(Deprecated, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_F4[0x4];                                       // 0x00F4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraPlatformSet                    Platforms;                                         // 0x00F8(0x0030)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraEmitterScalabilityOverrides    ScalabilityOverrides;                              // 0x0128(0x0010)(Edit, NativeAccessSpecifierPublic)
	uint8                                         bInterpolatedSpawning : 1;                         // 0x0138(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_139[0x7];                                      // 0x0139(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraParameterStore                 RendererBindings;                                  // 0x0140(0x0098)(NativeAccessSpecifierPublic)
	uint8                                         bFixedBounds : 1;                                  // 0x01D8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseMinDetailLevel : 1;                            // 0x01D8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseMaxDetailLevel : 1;                            // 0x01D8(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideGlobalSpawnCountScale : 1;                // 0x01D8(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRequiresPersistentIDs : 1;                        // 0x01D8(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bCombineEventSpawn : 1;                            // 0x01D8(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1D9[0x3];                                      // 0x01D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxDeltaTimePerTick;                               // 0x01DC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bLimitDeltaTime : 1;                               // 0x01E0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1E1[0x3];                                      // 0x01E1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxGPUParticlesSpawnPerFrame;                      // 0x01E4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bSimulationStagesEnabled : 1;                      // 0x01E8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDeprecatedShaderStagesEnabled : 1;                // 0x01E8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1E9[0x3];                                      // 0x01E9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         m_VfxMaterialIndependentParameter_RandomSeed;      // 0x01EC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         m_VfxUseSceneTexture : 1;                          // 0x01F0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         m_VfxDisableLowPerformance : 1;                    // 0x01F0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         m_VfxDisableIntelArc : 1;                          // 0x01F0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         m_VfxSpawnRate : 1;                                // 0x01F0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         m_VfxSpawnBurst : 1;                               // 0x01F0(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         m_VfxSpawnPerFrame : 1;                            // 0x01F0(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         m_VfxSpawnPerUnit : 1;                             // 0x01F0(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1F1[0x7];                                      // 0x01F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 UniqueEmitterName;                                 // 0x01F8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UNiagaraRendererProperties*>     RendererProperties;                                // 0x0208(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraEventScriptProperties>  EventHandlerScriptProps;                           // 0x0218(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<class UNiagaraSimulationStageBase*>    SimulationStages;                                  // 0x0228(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class UNiagaraScript*                         GPUComputeScript;                                  // 0x0238(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class FName>                           SharedEventGeneratorIds;                           // 0x0240(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class UNiagaraEmitter*                        Parent;                                            // 0x0250(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraVariable>               m_VfxRandomSeed_SpawnOnly_Params;                  // 0x0258(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraVariable>               m_VfxRandomSeed_EveryFrame_Params;                 // 0x0268(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_278[0xF0];                                     // 0x0278(0x00F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraEmitter) == 0x000368, "Wrong size on UNiagaraEmitter");
...
static_assert(offsetof(UNiagaraEmitter, bLocalSpace) == 0x000058, "Member 'UNiagaraEmitter::bLocalSpace' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, bDeterminism) == 0x000059, "Member 'UNiagaraEmitter::bDeterminism' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, RandomSeed) == 0x00005C, "Member 'UNiagaraEmitter::RandomSeed' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, AllocationMode) == 0x000060, "Member 'UNiagaraEmitter::AllocationMode' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, PreAllocationCount) == 0x000064, "Member 'UNiagaraEmitter::PreAllocationCount' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, UpdateScriptProps) == 0x000068, "Member 'UNiagaraEmitter::UpdateScriptProps' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SpawnScriptProps) == 0x000090, "Member 'UNiagaraEmitter::SpawnScriptProps' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SimTarget) == 0x0000B8, "Member 'UNiagaraEmitter::SimTarget' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, FixedBounds) == 0x0000BC, "Member 'UNiagaraEmitter::FixedBounds' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, MinDetailLevel) == 0x0000D8, "Member 'UNiagaraEmitter::MinDetailLevel' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, MaxDetailLevel) == 0x0000DC, "Member 'UNiagaraEmitter::MaxDetailLevel' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, GlobalSpawnCountScaleOverrides) == 0x0000E0, "Member 'UNiagaraEmitter::GlobalSpawnCountScaleOverrides' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, Platforms) == 0x0000F8, "Member 'UNiagaraEmitter::Platforms' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, ScalabilityOverrides) == 0x000128, "Member 'UNiagaraEmitter::ScalabilityOverrides' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, RendererBindings) == 0x000140, "Member 'UNiagaraEmitter::RendererBindings' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, MaxDeltaTimePerTick) == 0x0001DC, "Member 'UNiagaraEmitter::MaxDeltaTimePerTick' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, MaxGPUParticlesSpawnPerFrame) == 0x0001E4, "Member 'UNiagaraEmitter::MaxGPUParticlesSpawnPerFrame' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, m_VfxMaterialIndependentParameter_RandomSeed) == 0x0001EC, "Member 'UNiagaraEmitter::m_VfxMaterialIndependentParameter_RandomSeed' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, UniqueEmitterName) == 0x0001F8, "Member 'UNiagaraEmitter::UniqueEmitterName' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, RendererProperties) == 0x000208, "Member 'UNiagaraEmitter::RendererProperties' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, EventHandlerScriptProps) == 0x000218, "Member 'UNiagaraEmitter::EventHandlerScriptProps' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SimulationStages) == 0x000228, "Member 'UNiagaraEmitter::SimulationStages' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, GPUComputeScript) == 0x000238, "Member 'UNiagaraEmitter::GPUComputeScript' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SharedEventGeneratorIds) == 0x000240, "Member 'UNiagaraEmitter::SharedEventGeneratorIds' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, Parent) == 0x000250, "Member 'UNiagaraEmitter::Parent' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, m_VfxRandomSeed_SpawnOnly_Params) == 0x000258, "Member 'UNiagaraEmitter::m_VfxRandomSeed_SpawnOnly_Params' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, m_VfxRandomSeed_EveryFrame_Params) == 0x000268, "Member 'UNiagaraEmitter::m_VfxRandomSeed_EveryFrame_Params' has a wrong offset!");
...
// 0x02B8 (0x0678 - 0x03C0)
class UNiagaraLightRendererProperties final : public UNiagaraRendererProperties
{
public:
	uint8                                         bUseInverseSquaredFalloff : 1;                     // 0x03C0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectsTranslucency : 1;                          // 0x03C0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAlphaScalesBrightness : 1;                        // 0x03C0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_3C1[0x3];                                      // 0x03C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         RadiusScale;                                       // 0x03C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DefaultExponent;                                   // 0x03C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                ColorAdd;                                          // 0x03CC(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         RendererVisibility;                                // 0x03D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3DC[0x4];                                      // 0x03DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableAttributeBinding       LightRenderingEnabledBinding;                      // 0x03E0(0x0058)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       LightExponentBinding;                              // 0x0438(0x0058)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PositionBinding;                                   // 0x0490(0x0058)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       ColorBinding;                                      // 0x04E8(0x0058)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RadiusBinding;                                     // 0x0540(0x0058)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VolumetricScatteringBinding;                       // 0x0598(0x0058)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x05F0(0x0058)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraLightRendererProperties) == 0x000678, "Wrong size on UNiagaraLightRendererProperties");
static_assert(offsetof(UNiagaraLightRendererProperties, RadiusScale) == 0x0003C4, "Member 'UNiagaraLightRendererProperties::RadiusScale' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, DefaultExponent) == 0x0003C8, "Member 'UNiagaraLightRendererProperties::DefaultExponent' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, ColorAdd) == 0x0003CC, "Member 'UNiagaraLightRendererProperties::ColorAdd' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RendererVisibility) == 0x0003D8, "Member 'UNiagaraLightRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, LightRenderingEnabledBinding) == 0x0003E0, "Member 'UNiagaraLightRendererProperties::LightRenderingEnabledBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, LightExponentBinding) == 0x000438, "Member 'UNiagaraLightRendererProperties::LightExponentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, PositionBinding) == 0x000490, "Member 'UNiagaraLightRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, ColorBinding) == 0x0004E8, "Member 'UNiagaraLightRendererProperties::ColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RadiusBinding) == 0x000540, "Member 'UNiagaraLightRendererProperties::RadiusBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, VolumetricScatteringBinding) == 0x000598, "Member 'UNiagaraLightRendererProperties::VolumetricScatteringBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RendererVisibilityTagBinding) == 0x0005F0, "Member 'UNiagaraLightRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
...
{
public:
	TArray<struct FNiagaraMeshRendererMeshProperties> Meshes;                                            // 0x03C0(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	ENiagaraRendererSourceDataMode                SourceMode;                                        // 0x03D0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraSortMode                              SortMode;                                          // 0x03D1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3D2[0x2];                                      // 0x03D2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bOverrideMaterials : 1;                            // 0x03D4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSortOnlyWhenTranslucent : 1;                      // 0x03D4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_3D5[0x3];                                      // 0x03D5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	ENiagaraRendererSortPrecision                 SortPrecision;                                     // 0x03D8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3D9[0x3];                                      // 0x03D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bGpuLowLatencyTranslucency : 1;                    // 0x03DC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSubImageBlend : 1;                                // 0x03DC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableFrustumCulling : 1;                         // 0x03DC(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableCameraDistanceCulling : 1;                  // 0x03DC(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableMeshFlipbook : 1;                           // 0x03DC(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_3DD[0x3];                                      // 0x03DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FNiagaraMeshMaterialOverride>   OverrideMaterials;                                 // 0x03E0(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FVector2D                              SubImageSize;                                      // 0x03F0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraMeshFacingMode                        FacingMode;                                        // 0x03F8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3F9[0x3];                                      // 0x03F9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bLockedAxisEnable : 1;                             // 0x03FC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_3FD[0x3];                                      // 0x03FD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                LockedAxis;                                        // 0x0400(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraMeshLockedAxisSpace                   LockedAxisSpace;                                   // 0x040C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_40D[0x3];                                      // 0x040D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinCameraDistance;                                 // 0x0410(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxCameraDistance;                                 // 0x0414(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        RendererVisibility;                                // 0x0418(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_41C[0x4];                                      // 0x041C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableAttributeBinding       PositionBinding;                                   // 0x0420(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       ColorBinding;                                      // 0x0478(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VelocityBinding;                                   // 0x04D0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MeshOrientationBinding;                            // 0x0528(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       ScaleBinding;                                      // 0x0580(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SubImageIndexBinding;                              // 0x05D8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MaterialRandomBinding;                             // 0x0630(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       CustomSortingBinding;                              // 0x0688(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       NormalizedAgeBinding;                              // 0x06E0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       CameraOffsetBinding;                               // 0x0738(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0790(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MeshIndexBinding;                                  // 0x07E8(0x0058)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraMaterialAttributeBinding> MaterialParameterBindings;                         // 0x0840(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PreviousPositionBinding;                           // 0x0850(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PreviousVelocityBinding;                           // 0x08A8(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PreviousScaleBinding;                              // 0x0900(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PreviousMeshOrientationBinding;                    // 0x0958(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PreviousCameraOffsetBinding;                       // 0x09B0(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PreviousSubImageIndexBinding;                      // 0x0A08(0x0058)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_A60[0x68];                                     // 0x0A60(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	class UStaticMesh*                            ParticleMesh;                                      // 0x0AC8(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                PivotOffset;                                       // 0x0AD0(0x000C)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ENiagaraMeshPivotOffsetSpace                  PivotOffsetSpace;                                  // 0x0ADC(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_ADD[0x3];                                      // 0x0ADD(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraMeshRendererProperties) == 0x000AE0, "Wrong size on UNiagaraMeshRendererProperties");
static_assert(offsetof(UNiagaraMeshRendererProperties, Meshes) == 0x0003C0, "Member 'UNiagaraMeshRendererProperties::Meshes' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SourceMode) == 0x0003D0, "Member 'UNiagaraMeshRendererProperties::SourceMode' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SortMode) == 0x0003D1, "Member 'UNiagaraMeshRendererProperties::SortMode' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SortPrecision) == 0x0003D8, "Member 'UNiagaraMeshRendererProperties::SortPrecision' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, OverrideMaterials) == 0x0003E0, "Member 'UNiagaraMeshRendererProperties::OverrideMaterials' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SubImageSize) == 0x0003F0, "Member 'UNiagaraMeshRendererProperties::SubImageSize' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, FacingMode) == 0x0003F8, "Member 'UNiagaraMeshRendererProperties::FacingMode' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxis) == 0x000400, "Member 'UNiagaraMeshRendererProperties::LockedAxis' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxisSpace) == 0x00040C, "Member 'UNiagaraMeshRendererProperties::LockedAxisSpace' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MinCameraDistance) == 0x000410, "Member 'UNiagaraMeshRendererProperties::MinCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaxCameraDistance) == 0x000414, "Member 'UNiagaraMeshRendererProperties::MaxCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibility) == 0x000418, "Member 'UNiagaraMeshRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PositionBinding) == 0x000420, "Member 'UNiagaraMeshRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, ColorBinding) == 0x000478, "Member 'UNiagaraMeshRendererProperties::ColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, VelocityBinding) == 0x0004D0, "Member 'UNiagaraMeshRendererProperties::VelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MeshOrientationBinding) == 0x000528, "Member 'UNiagaraMeshRendererProperties::MeshOrientationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, ScaleBinding) == 0x000580, "Member 'UNiagaraMeshRendererProperties::ScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SubImageIndexBinding) == 0x0005D8, "Member 'UNiagaraMeshRendererProperties::SubImageIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialRandomBinding) == 0x000630, "Member 'UNiagaraMeshRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, CustomSortingBinding) == 0x000688, "Member 'UNiagaraMeshRendererProperties::CustomSortingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, NormalizedAgeBinding) == 0x0006E0, "Member 'UNiagaraMeshRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, CameraOffsetBinding) == 0x000738, "Member 'UNiagaraMeshRendererProperties::CameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibilityTagBinding) == 0x000790, "Member 'UNiagaraMeshRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MeshIndexBinding) == 0x0007E8, "Member 'UNiagaraMeshRendererProperties::MeshIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialParameterBindings) == 0x000840, "Member 'UNiagaraMeshRendererProperties::MaterialParameterBindings' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PreviousPositionBinding) == 0x000850, "Member 'UNiagaraMeshRendererProperties::PreviousPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PreviousVelocityBinding) == 0x0008A8, "Member 'UNiagaraMeshRendererProperties::PreviousVelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PreviousScaleBinding) == 0x000900, "Member 'UNiagaraMeshRendererProperties::PreviousScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PreviousMeshOrientationBinding) == 0x000958, "Member 'UNiagaraMeshRendererProperties::PreviousMeshOrientationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PreviousCameraOffsetBinding) == 0x0009B0, "Member 'UNiagaraMeshRendererProperties::PreviousCameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PreviousSubImageIndexBinding) == 0x000A08, "Member 'UNiagaraMeshRendererProperties::PreviousSubImageIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, ParticleMesh) == 0x000AC8, "Member 'UNiagaraMeshRendererProperties::ParticleMesh' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffset) == 0x000AD0, "Member 'UNiagaraMeshRendererProperties::PivotOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffsetSpace) == 0x000ADC, "Member 'UNiagaraMeshRendererProperties::PivotOffsetSpace' has a wrong offset!");
...
public:
	...
	struct FNiagaraParameterStore                 ParameterStorage;                                  // 0x0040(0x0098)(NativeAccessSpecifierPrivate)
...
public:
	...
	void VfxSetMatrixParameter(const class FString& InVariableName, const struct FMatrix& InValue);
...
static_assert(sizeof(UNiagaraParameterCollectionInstance) == 0x000100, "Wrong size on UNiagaraParameterCollectionInstance");
...
// 0x0840 (0x0C00 - 0x03C0)
class UNiagaraRibbonRendererProperties final : public UNiagaraRendererProperties
{
public:
	class UMaterialInterface*                     Material;                                          // 0x03C0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraUserParameterBinding           MaterialUserParamBinding;                          // 0x03C8(0x0020)(Edit, NativeAccessSpecifierPublic)
	ENiagaraRibbonFacingMode                      FacingMode;                                        // 0x03E8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3E9[0x3];                                      // 0x03E9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraRibbonUVSettings               UV0Settings;                                       // 0x03EC(0x0024)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FNiagaraRibbonUVSettings               UV1Settings;                                       // 0x0410(0x0024)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         MaxNumRibbons;                                     // 0x0434(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseGPUInit;                                       // 0x0438(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraRibbonDrawDirection                   DrawDirection;                                     // 0x0439(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraRibbonShapeMode                       Shape;                                             // 0x043A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableAccurateGeometry;                           // 0x043B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         WidthSegmentationCount;                            // 0x043C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MultiPlaneCount;                                   // 0x0440(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TubeSubdivisions;                                  // 0x0444(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraRibbonShapeCustomVertex> CustomVertices;                                    // 0x0448(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         CurveTension;                                      // 0x0458(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraRibbonTessellationMode                TessellationMode;                                  // 0x045C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_45D[0x3];                                      // 0x045D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         TessellationFactor;                                // 0x0460(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseConstantFactor;                                // 0x0464(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_465[0x3];                                      // 0x0465(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TessellationAngle;                                 // 0x0468(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bScreenSpaceTessellation;                          // 0x046C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_46D[0x3];                                      // 0x046D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableAttributeBinding       PositionBinding;                                   // 0x0470(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       ColorBinding;                                      // 0x04C8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VelocityBinding;                                   // 0x0520(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       NormalizedAgeBinding;                              // 0x0578(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RibbonTwistBinding;                                // 0x05D0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RibbonWidthBinding;                                // 0x0628(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RibbonFacingBinding;                               // 0x0680(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RibbonIdBinding;                                   // 0x06D8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RibbonLinkOrderBinding;                            // 0x0730(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MaterialRandomBinding;                             // 0x0788(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RibbonUVDistance;                                  // 0x07E0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       U0OverrideBinding;                                 // 0x0838(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       V0RangeOverrideBinding;                            // 0x0890(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       U1OverrideBinding;                                 // 0x08E8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       V1RangeOverrideBinding;                            // 0x0940(0x0058)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraMaterialAttributeBinding> MaterialParameterBindings;                         // 0x0998(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevPositionBinding;                               // 0x09A8(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevRibbonWidthBinding;                            // 0x0A00(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevRibbonFacingBinding;                           // 0x0A58(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevRibbonTwistBinding;                            // 0x0AB0(0x0058)(Transient, NativeAccessSpecifierPublic)
	uint8                                         m_bVfxEmitterUpdateTrail : 1;                      // 0x0B08(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         m_bVfxParticleUpdateTrail : 1;                     // 0x0B08(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_B09[0x7];                                      // 0x0B09(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableAttributeBinding       SubImageIndexBinding;                              // 0x0B10(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FVector2D                              SubImageSize;                                      // 0x0B68(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bSubImageBlend : 1;                                // 0x0B70(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_B71[0x8F];                                     // 0x0B71(0x008F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraRibbonRendererProperties) == 0x000C00, "Wrong size on UNiagaraRibbonRendererProperties");
static_assert(offsetof(UNiagaraRibbonRendererProperties, Material) == 0x0003C0, "Member 'UNiagaraRibbonRendererProperties::Material' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialUserParamBinding) == 0x0003C8, "Member 'UNiagaraRibbonRendererProperties::MaterialUserParamBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, FacingMode) == 0x0003E8, "Member 'UNiagaraRibbonRendererProperties::FacingMode' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, UV0Settings) == 0x0003EC, "Member 'UNiagaraRibbonRendererProperties::UV0Settings' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, UV1Settings) == 0x000410, "Member 'UNiagaraRibbonRendererProperties::UV1Settings' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaxNumRibbons) == 0x000434, "Member 'UNiagaraRibbonRendererProperties::MaxNumRibbons' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bUseGPUInit) == 0x000438, "Member 'UNiagaraRibbonRendererProperties::bUseGPUInit' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DrawDirection) == 0x000439, "Member 'UNiagaraRibbonRendererProperties::DrawDirection' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, Shape) == 0x00043A, "Member 'UNiagaraRibbonRendererProperties::Shape' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bEnableAccurateGeometry) == 0x00043B, "Member 'UNiagaraRibbonRendererProperties::bEnableAccurateGeometry' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, WidthSegmentationCount) == 0x00043C, "Member 'UNiagaraRibbonRendererProperties::WidthSegmentationCount' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MultiPlaneCount) == 0x000440, "Member 'UNiagaraRibbonRendererProperties::MultiPlaneCount' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TubeSubdivisions) == 0x000444, "Member 'UNiagaraRibbonRendererProperties::TubeSubdivisions' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, CustomVertices) == 0x000448, "Member 'UNiagaraRibbonRendererProperties::CustomVertices' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, CurveTension) == 0x000458, "Member 'UNiagaraRibbonRendererProperties::CurveTension' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationMode) == 0x00045C, "Member 'UNiagaraRibbonRendererProperties::TessellationMode' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationFactor) == 0x000460, "Member 'UNiagaraRibbonRendererProperties::TessellationFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bUseConstantFactor) == 0x000464, "Member 'UNiagaraRibbonRendererProperties::bUseConstantFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationAngle) == 0x000468, "Member 'UNiagaraRibbonRendererProperties::TessellationAngle' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bScreenSpaceTessellation) == 0x00046C, "Member 'UNiagaraRibbonRendererProperties::bScreenSpaceTessellation' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PositionBinding) == 0x000470, "Member 'UNiagaraRibbonRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, ColorBinding) == 0x0004C8, "Member 'UNiagaraRibbonRendererProperties::ColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, VelocityBinding) == 0x000520, "Member 'UNiagaraRibbonRendererProperties::VelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, NormalizedAgeBinding) == 0x000578, "Member 'UNiagaraRibbonRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonTwistBinding) == 0x0005D0, "Member 'UNiagaraRibbonRendererProperties::RibbonTwistBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonWidthBinding) == 0x000628, "Member 'UNiagaraRibbonRendererProperties::RibbonWidthBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonFacingBinding) == 0x000680, "Member 'UNiagaraRibbonRendererProperties::RibbonFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonIdBinding) == 0x0006D8, "Member 'UNiagaraRibbonRendererProperties::RibbonIdBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonLinkOrderBinding) == 0x000730, "Member 'UNiagaraRibbonRendererProperties::RibbonLinkOrderBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialRandomBinding) == 0x000788, "Member 'UNiagaraRibbonRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonUVDistance) == 0x0007E0, "Member 'UNiagaraRibbonRendererProperties::RibbonUVDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, U0OverrideBinding) == 0x000838, "Member 'UNiagaraRibbonRendererProperties::U0OverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, V0RangeOverrideBinding) == 0x000890, "Member 'UNiagaraRibbonRendererProperties::V0RangeOverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, U1OverrideBinding) == 0x0008E8, "Member 'UNiagaraRibbonRendererProperties::U1OverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, V1RangeOverrideBinding) == 0x000940, "Member 'UNiagaraRibbonRendererProperties::V1RangeOverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialParameterBindings) == 0x000998, "Member 'UNiagaraRibbonRendererProperties::MaterialParameterBindings' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PrevPositionBinding) == 0x0009A8, "Member 'UNiagaraRibbonRendererProperties::PrevPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PrevRibbonWidthBinding) == 0x000A00, "Member 'UNiagaraRibbonRendererProperties::PrevRibbonWidthBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PrevRibbonFacingBinding) == 0x000A58, "Member 'UNiagaraRibbonRendererProperties::PrevRibbonFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PrevRibbonTwistBinding) == 0x000AB0, "Member 'UNiagaraRibbonRendererProperties::PrevRibbonTwistBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, SubImageIndexBinding) == 0x000B10, "Member 'UNiagaraRibbonRendererProperties::SubImageIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, SubImageSize) == 0x000B68, "Member 'UNiagaraRibbonRendererProperties::SubImageSize' has a wrong offset!");
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraScript*                         m_VfxParentEmitterScript;                          // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_38[0x4];                                       // 0x0038(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	ENiagaraScriptUsage                           Usage;                                             // 0x003C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3D[0x3];                                       // 0x003D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  UsageId;                                           // 0x0040(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FNiagaraParameterStore                 RapidIterationParameters;                          // 0x0050(0x0098)(NativeAccessSpecifierPublic)
	struct FNiagaraScriptExecutionParameterStore  ScriptExecutionParamStore;                         // 0x00E8(0x00B8)(NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraBoundParameter>         ScriptExecutionBoundParameters;                    // 0x01A0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	struct FNiagaraVMExecutableDataId             CachedScriptVMId;                                  // 0x01B0(0x0058)(HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_208[0x10];                                     // 0x0208(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVMExecutableData               CachedScriptVM;                                    // 0x0218(0x0108)(NativeAccessSpecifierPrivate)
	TArray<class UNiagaraParameterCollection*>    CachedParameterCollectionReferences;               // 0x0320(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UNiagaraScript, m_VfxParentEmitterScript) == 0x000030, "Member 'UNiagaraScript::m_VfxParentEmitterScript' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, Usage) == 0x00003C, "Member 'UNiagaraScript::Usage' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, UsageId) == 0x000040, "Member 'UNiagaraScript::UsageId' has a wrong offset!");
...
static_assert(offsetof(UNiagaraScript, ScriptExecutionParamStore) == 0x0000E8, "Member 'UNiagaraScript::ScriptExecutionParamStore' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, ScriptExecutionBoundParameters) == 0x0001A0, "Member 'UNiagaraScript::ScriptExecutionBoundParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, CachedScriptVMId) == 0x0001B0, "Member 'UNiagaraScript::CachedScriptVMId' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, CachedScriptVM) == 0x000218, "Member 'UNiagaraScript::CachedScriptVM' has a wrong offset!");
...
public:
	...
	ENiagaraDefaultSortPrecision                  DefaultSortPrecision;                              // 0x00D1(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENDISkelMesh_GpuMaxInfluences                 NDISkelMesh_GpuMaxInfluences;                      // 0x00D2(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENDISkelMesh_GpuUniformSamplingFormat         NDISkelMesh_GpuUniformSamplingFormat;              // 0x00D3(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENDISkelMesh_AdjacencyTriangleIndexFormat     NDISkelMesh_AdjacencyTriangleIndexFormat;          // 0x00D4(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          NDIStaticMesh_AllowDistanceFields;                 // 0x00D5(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<struct FNiagaraPlatformSetRedirect>    PlatformSetRedirects;                              // 0x00E8(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraSettings) == 0x0000F8, "Wrong size on UNiagaraSettings");
...
static_assert(offsetof(UNiagaraSettings, DefaultSortPrecision) == 0x0000D1, "Member 'UNiagaraSettings::DefaultSortPrecision' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_GpuMaxInfluences) == 0x0000D2, "Member 'UNiagaraSettings::NDISkelMesh_GpuMaxInfluences' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_GpuUniformSamplingFormat) == 0x0000D3, "Member 'UNiagaraSettings::NDISkelMesh_GpuUniformSamplingFormat' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_AdjacencyTriangleIndexFormat) == 0x0000D4, "Member 'UNiagaraSettings::NDISkelMesh_AdjacencyTriangleIndexFormat' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, NDIStaticMesh_AllowDistanceFields) == 0x0000D5, "Member 'UNiagaraSettings::NDIStaticMesh_AllowDistanceFields' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSettings, PlatformSetRedirects) == 0x0000E8, "Member 'UNiagaraSettings::PlatformSetRedirects' has a wrong offset!");
...
public:
	...
	struct FNiagaraSimCacheLayout                 CacheLayout;                                       // 0x0060(0x0058)(NativeAccessSpecifierPublic)
	TArray<struct FNiagaraSimCacheFrame>          CacheFrames;                                       // 0x00B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<struct FNiagaraVariableBase, class UObject*> DataInterfaceStorage;                              // 0x00C8(0x0050)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraSimCache) == 0x000120, "Wrong size on UNiagaraSimCache");
...
static_assert(offsetof(UNiagaraSimCache, bNeedsReadComponentMappingRecache) == 0x000058, "Member 'UNiagaraSimCache::bNeedsReadComponentMappingRecache' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, CacheLayout) == 0x000060, "Member 'UNiagaraSimCache::CacheLayout' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, CacheFrames) == 0x0000B8, "Member 'UNiagaraSimCache::CacheFrames' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, DataInterfaceStorage) == 0x0000C8, "Member 'UNiagaraSimCache::DataInterfaceStorage' has a wrong offset!");
...
public:
	...
	struct FNiagaraVariableAttributeBinding       ElementCountBinding;                               // 0x0098(0x0058)(Edit, NativeAccessSpecifierPublic)
	ENiagaraIterationSource                       IterationSource;                                   // 0x00F0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F1[0x3];                                       // 0x00F1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Iterations;                                        // 0x00F4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       NumIterationsBinding;                              // 0x00F8(0x0058)(Edit, NativeAccessSpecifierPublic)
	uint8                                         bSpawnOnly : 1;                                    // 0x0150(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_151[0x3];                                      // 0x0151(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	ENiagaraSimStageExecuteBehavior               ExecuteBehavior;                                   // 0x0154(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_155[0x3];                                      // 0x0155(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bDisablePartialParticleUpdate : 1;                 // 0x0158(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_159[0x7];                                      // 0x0159(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableDataInterfaceBinding   DataInterface;                                     // 0x0160(0x0020)(Edit, NativeAccessSpecifierPublic)
	uint8                                         bParticleIterationStateEnabled : 1;                // 0x0180(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_181[0x7];                                      // 0x0181(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableAttributeBinding       ParticleIterationStateBinding;                     // 0x0188(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FIntPoint                              ParticleIterationStateRange;                       // 0x01E0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bGpuDispatchForceLinear : 1;                       // 0x01E8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideGpuDispatchNumThreads : 1;                // 0x01E8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1E9[0x3];                                      // 0x01E9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FIntVector                             OverrideGpuDispatchNumThreads;                     // 0x01EC(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNiagaraSimulationStageGeneric, IterationSource) == 0x0000F0, "Member 'UNiagaraSimulationStageGeneric::IterationSource' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, Iterations) == 0x0000F4, "Member 'UNiagaraSimulationStageGeneric::Iterations' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, NumIterationsBinding) == 0x0000F8, "Member 'UNiagaraSimulationStageGeneric::NumIterationsBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ExecuteBehavior) == 0x000154, "Member 'UNiagaraSimulationStageGeneric::ExecuteBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, DataInterface) == 0x000160, "Member 'UNiagaraSimulationStageGeneric::DataInterface' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ParticleIterationStateBinding) == 0x000188, "Member 'UNiagaraSimulationStageGeneric::ParticleIterationStateBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ParticleIterationStateRange) == 0x0001E0, "Member 'UNiagaraSimulationStageGeneric::ParticleIterationStateRange' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, OverrideGpuDispatchNumThreads) == 0x0001EC, "Member 'UNiagaraSimulationStageGeneric::OverrideGpuDispatchNumThreads' has a wrong offset!");
...
{
public:
	uint8                                         bSupportLargeWorldCoordinates : 1;                 // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideCastShadow : 1;                           // 0x00A0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideReceivesDecals : 1;                       // 0x00A0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideRenderCustomDepth : 1;                    // 0x00A0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideCustomDepthStencilValue : 1;              // 0x00A0(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideCustomDepthStencilWriteMask : 1;          // 0x00A0(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideTranslucencySortPriority : 1;             // 0x00A0(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideTranslucencySortDistanceOffset : 1;       // 0x00A0(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bCastShadow : 1;                                   // 0x00A1(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReceivesDecals : 1;                               // 0x00A1(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRenderCustomDepth : 1;                            // 0x00A1(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDisableExperimentalVM : 1;                        // 0x00A1(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	ERendererStencilMask                          CustomDepthStencilWriteMask;                       // 0x00A2(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A3[0x1];                                       // 0x00A3(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CustomDepthStencilValue;                           // 0x00A4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TranslucencySortPriority;                          // 0x00A8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TranslucencySortDistanceOffset;                    // 0x00AC(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDumpDebugSystemInfo;                              // 0x00B0(0x0001)(Edit, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDumpDebugEmitterInfo;                             // 0x00B1(0x0001)(Edit, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B2[0x1];                                       // 0x00B2(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bRequireCurrentFrameData;                          // 0x00B3(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B4[0x14];                                      // 0x00B4(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bFixedBounds : 1;                                  // 0x00C8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_C9[0x7];                                       // 0x00C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraEffectType*                     EffectType;                                        // 0x00D0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bOverrideScalabilitySettings;                      // 0x00D8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_D9[0x3];                                       // 0x00D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bOverrideAllowCullingForLocalPlayers : 1;          // 0x00DC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bAllowCullingForLocalPlayersOverride : 1;          // 0x00DC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_DD[0x3];                                       // 0x00DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FNiagaraSystemScalabilityOverride> ScalabilityOverrides;                              // 0x00E0(0x0010)(ZeroConstructor, Deprecated, Protected, NativeAccessSpecifierProtected)
	struct FNiagaraSystemScalabilityOverrides     SystemScalabilityOverrides;                        // 0x00F0(0x0010)(Edit, Protected, NativeAccessSpecifierProtected)
	TArray<struct FNiagaraEmitterHandle>          EmitterHandles;                                    // 0x0100(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<class UNiagaraParameterCollectionInstance*> ParameterCollectionOverrides;                      // 0x0110(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	class UNiagaraScript*                         SystemSpawnScript;                                 // 0x0120(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNiagaraScript*                         SystemUpdateScript;                                // 0x0128(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_130[0x18];                                     // 0x0130(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<uint32, class UObject*>                  m_VfxRefDataInterfaceAssetMap;                     // 0x0148(0x0050)(Protected, NativeAccessSpecifierProtected)
	struct FNiagaraSystemCompiledData             SystemCompiledData;                                // 0x0198(0x0250)(Protected, NativeAccessSpecifierProtected)
	struct FNiagaraUserRedirectionParameterStore  ExposedParameters;                                 // 0x03E8(0x00E8)(Protected, NativeAccessSpecifierProtected)
	struct FBox                                   FixedBounds;                                       // 0x04D0(0x001C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	bool                                          bAutoDeactivate;                                   // 0x04EC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDeterminism;                                      // 0x04ED(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4EE[0x2];                                      // 0x04EE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         RandomSeed;                                        // 0x04F0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         WarmupTime;                                        // 0x04F4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         WarmupTickCount;                                   // 0x04F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         WarmupTickDelta;                                   // 0x04FC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bFixedTickDelta;                                   // 0x0500(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_501[0x3];                                      // 0x0501(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         FixedTickDeltaTime;                                // 0x0504(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHasSystemScriptDIsWithPerInstanceData;            // 0x0508(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bNeedsGPUContextInitForDataInterfaces;             // 0x0509(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_50A[0x6];                                      // 0x050A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           UserDINamesReadInSystemScripts;                    // 0x0510(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_520[0x138];                                    // 0x0520(0x0138)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraSystem) == 0x000658, "Wrong size on UNiagaraSystem");
static_assert(offsetof(UNiagaraSystem, CustomDepthStencilWriteMask) == 0x0000A2, "Member 'UNiagaraSystem::CustomDepthStencilWriteMask' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, CustomDepthStencilValue) == 0x0000A4, "Member 'UNiagaraSystem::CustomDepthStencilValue' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, TranslucencySortPriority) == 0x0000A8, "Member 'UNiagaraSystem::TranslucencySortPriority' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, TranslucencySortDistanceOffset) == 0x0000AC, "Member 'UNiagaraSystem::TranslucencySortDistanceOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bDumpDebugSystemInfo) == 0x0000B0, "Member 'UNiagaraSystem::bDumpDebugSystemInfo' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bDumpDebugEmitterInfo) == 0x0000B1, "Member 'UNiagaraSystem::bDumpDebugEmitterInfo' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bRequireCurrentFrameData) == 0x0000B3, "Member 'UNiagaraSystem::bRequireCurrentFrameData' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, EffectType) == 0x0000D0, "Member 'UNiagaraSystem::EffectType' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bOverrideScalabilitySettings) == 0x0000D8, "Member 'UNiagaraSystem::bOverrideScalabilitySettings' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, ScalabilityOverrides) == 0x0000E0, "Member 'UNiagaraSystem::ScalabilityOverrides' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemScalabilityOverrides) == 0x0000F0, "Member 'UNiagaraSystem::SystemScalabilityOverrides' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, EmitterHandles) == 0x000100, "Member 'UNiagaraSystem::EmitterHandles' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, ParameterCollectionOverrides) == 0x000110, "Member 'UNiagaraSystem::ParameterCollectionOverrides' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemSpawnScript) == 0x000120, "Member 'UNiagaraSystem::SystemSpawnScript' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemUpdateScript) == 0x000128, "Member 'UNiagaraSystem::SystemUpdateScript' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, m_VfxRefDataInterfaceAssetMap) == 0x000148, "Member 'UNiagaraSystem::m_VfxRefDataInterfaceAssetMap' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemCompiledData) == 0x000198, "Member 'UNiagaraSystem::SystemCompiledData' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, ExposedParameters) == 0x0003E8, "Member 'UNiagaraSystem::ExposedParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, FixedBounds) == 0x0004D0, "Member 'UNiagaraSystem::FixedBounds' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bAutoDeactivate) == 0x0004EC, "Member 'UNiagaraSystem::bAutoDeactivate' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bDeterminism) == 0x0004ED, "Member 'UNiagaraSystem::bDeterminism' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, RandomSeed) == 0x0004F0, "Member 'UNiagaraSystem::RandomSeed' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTime) == 0x0004F4, "Member 'UNiagaraSystem::WarmupTime' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTickCount) == 0x0004F8, "Member 'UNiagaraSystem::WarmupTickCount' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTickDelta) == 0x0004FC, "Member 'UNiagaraSystem::WarmupTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bFixedTickDelta) == 0x000500, "Member 'UNiagaraSystem::bFixedTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, FixedTickDeltaTime) == 0x000504, "Member 'UNiagaraSystem::FixedTickDeltaTime' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bHasSystemScriptDIsWithPerInstanceData) == 0x000508, "Member 'UNiagaraSystem::bHasSystemScriptDIsWithPerInstanceData' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bNeedsGPUContextInitForDataInterfaces) == 0x000509, "Member 'UNiagaraSystem::bNeedsGPUContextInitForDataInterfaces' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, UserDINamesReadInSystemScripts) == 0x000510, "Member 'UNiagaraSystem::UserDINamesReadInSystemScripts' has a wrong offset!");
