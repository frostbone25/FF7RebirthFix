...
{
public:
	struct FEQSParametrizedQueryExecutionRequest  EQSRequest;                                        // 0x0098(0x0050)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FBlackboardKeySelector                 QueryResultBlackboardKey;                          // 0x00E8(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UBTService_RunEQS, QueryResultBlackboardKey) == 0x0000E8, "Member 'UBTService_RunEQS::QueryResultBlackboardKey' has a wrong offset!");
...
public:
	...
	struct FEQSParametrizedQueryExecutionRequest  EQSRequest;                                        // 0x00F8(0x0050)(Edit, NativeAccessSpecifierPublic)
...
// Class AIModule.EnvQueryConditional
// 0x0020 (0x0050 - 0x0030)
class UEnvQueryConditional : public UEnvQueryNode
{
public:
	uint8                                         Pad_30[0x4];                                       // 0x0030(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bInverseCondition : 1;                             // 0x0034(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_35[0x3];                                       // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 Comment;                                           // 0x0038(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_48[0x8];                                       // 0x0048(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"EnvQueryConditional">();
	}
	static class UEnvQueryConditional* GetDefaultObj()
	{
		return GetDefaultObjImpl<UEnvQueryConditional>();
	}
};
static_assert(alignof(UEnvQueryConditional) == 0x000008, "Wrong alignment on UEnvQueryConditional");
static_assert(sizeof(UEnvQueryConditional) == 0x000050, "Wrong size on UEnvQueryConditional");
static_assert(offsetof(UEnvQueryConditional, Comment) == 0x000038, "Member 'UEnvQueryConditional::Comment' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class AActor* MovingActor, struct FVector& DestinationPoint)> OnSmartLinkReached;                                // 0x0268(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAITask_RunEQS) == 0x0000F0, "Wrong size on UAITask_RunEQS");
...
public:
	...
	struct FAIDataProviderFloatValue              InnerSpace;                                        // 0x0178(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	bool                                          bInnerSpaceSlide;                                  // 0x01B0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1B1[0x7];                                      // 0x01B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAIDataProviderFloatValue              YawOffset;                                         // 0x01B8(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FAIDataProviderFloatValue              ForwardOffset;                                     // 0x01F0(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	bool                                          bDefineArc;                                        // 0x0228(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_229[0x7];                                      // 0x0229(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEnvDirection                          ArcDirection;                                      // 0x0230(0x0020)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEnvQueryGenerator_Cone) == 0x000250, "Wrong size on UEnvQueryGenerator_Cone");
...
static_assert(offsetof(UEnvQueryGenerator_Cone, InnerSpace) == 0x000178, "Member 'UEnvQueryGenerator_Cone::InnerSpace' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Cone, bInnerSpaceSlide) == 0x0001B0, "Member 'UEnvQueryGenerator_Cone::bInnerSpaceSlide' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Cone, YawOffset) == 0x0001B8, "Member 'UEnvQueryGenerator_Cone::YawOffset' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Cone, ForwardOffset) == 0x0001F0, "Member 'UEnvQueryGenerator_Cone::ForwardOffset' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Cone, bDefineArc) == 0x000228, "Member 'UEnvQueryGenerator_Cone::bDefineArc' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Cone, ArcDirection) == 0x000230, "Member 'UEnvQueryGenerator_Cone::ArcDirection' has a wrong offset!");
...
class alignas(0x10) UEnvQueryManager final : public UAISubsystem
{
public:
	...
	float                                         MaxAllowedTestingTimeLong;                         // 0x0130(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bTestQueriesUsingBreadth;                          // 0x0134(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_135[0x3];                                      // 0x0135(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         QueryCountWarningThreshold;                        // 0x0138(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(alignof(UEnvQueryManager) == 0x000010, "Wrong alignment on UEnvQueryManager");
static_assert(sizeof(UEnvQueryManager) == 0x000240, "Wrong size on UEnvQueryManager");
...
static_assert(offsetof(UEnvQueryManager, MaxAllowedTestingTimeLong) == 0x000130, "Member 'UEnvQueryManager::MaxAllowedTestingTimeLong' has a wrong offset!");
static_assert(offsetof(UEnvQueryManager, bTestQueriesUsingBreadth) == 0x000134, "Member 'UEnvQueryManager::bTestQueriesUsingBreadth' has a wrong offset!");
static_assert(offsetof(UEnvQueryManager, QueryCountWarningThreshold) == 0x000138, "Member 'UEnvQueryManager::QueryCountWarningThreshold' has a wrong offset!");
...
public:
	...
	TArray<class UEnvQueryConditional*>           Conditionals;                                      // 0x0040(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEnvQueryOption) == 0x000050, "Wrong size on UEnvQueryOption");
...
static_assert(offsetof(UEnvQueryOption, Conditionals) == 0x000040, "Member 'UEnvQueryOption::Conditionals' has a wrong offset!");
