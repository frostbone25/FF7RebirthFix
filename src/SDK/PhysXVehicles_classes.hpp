...
public:
	...
	uint8                                         BitPad_140_3 : 1;                                  // 0x0140(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bRawHandbrakeInput : 1;                            // 0x0140(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bRawGearUpInput : 1;                               // 0x0140(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bRawGearDownInput : 1;                             // 0x0140(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         BitPad_140_7 : 1;                                  // 0x0140(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	...
	uint8                                         Pad_264[0x24];                                     // 0x0264(0x0024)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWheeledVehicleMovementComponent) == 0x000288, "Wrong size on UWheeledVehicleMovementComponent");
...
static_assert(sizeof(USimpleWheeledVehicleMovementComponent) == 0x000288, "Wrong size on USimpleWheeledVehicleMovementComponent");
...
{
public:
	uint8                                         Pad_2D8[0x7A8];                                    // 0x02D8(0x07A8)(Fixing Size After Last Property [ Dumper-7 ])
	class UWheeledVehicleMovementComponent*       WheeledVehicleMovementComponent;                   // 0x0A80(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UVehicleAnimInstance) == 0x000A90, "Wrong size on UVehicleAnimInstance");
static_assert(offsetof(UVehicleAnimInstance, WheeledVehicleMovementComponent) == 0x000A80, "Member 'UVehicleAnimInstance::WheeledVehicleMovementComponent' has a wrong offset!");
...
{
public:
	struct FVehicleEngineData                     EngineSetup;                                       // 0x0288(0x00A0)(Edit, NativeAccessSpecifierPublic)
	struct FVehicleDifferential4WData             DifferentialSetup;                                 // 0x0328(0x001C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         AckermannAccuracy;                                 // 0x0344(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVehicleTransmissionData               TransmissionSetup;                                 // 0x0348(0x0030)(Edit, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     SteeringCurve;                                     // 0x0378(0x0088)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UWheeledVehicleMovementComponent4W) == 0x000400, "Wrong size on UWheeledVehicleMovementComponent4W");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, EngineSetup) == 0x000288, "Member 'UWheeledVehicleMovementComponent4W::EngineSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, DifferentialSetup) == 0x000328, "Member 'UWheeledVehicleMovementComponent4W::DifferentialSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, AckermannAccuracy) == 0x000344, "Member 'UWheeledVehicleMovementComponent4W::AckermannAccuracy' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, TransmissionSetup) == 0x000348, "Member 'UWheeledVehicleMovementComponent4W::TransmissionSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, SteeringCurve) == 0x000378, "Member 'UWheeledVehicleMovementComponent4W::SteeringCurve' has a wrong offset!");
...
static_assert(sizeof(UWheeledVehicleMovementComponentNW) == 0x000400, "Wrong size on UWheeledVehicleMovementComponentNW");
static_assert(offsetof(UWheeledVehicleMovementComponentNW, EngineSetup) == 0x000288, "Member 'UWheeledVehicleMovementComponentNW::EngineSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponentNW, DifferentialSetup) == 0x000328, "Member 'UWheeledVehicleMovementComponentNW::DifferentialSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponentNW, AckermannAccuracy) == 0x000344, "Member 'UWheeledVehicleMovementComponentNW::AckermannAccuracy' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponentNW, TransmissionSetup) == 0x000348, "Member 'UWheeledVehicleMovementComponentNW::TransmissionSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponentNW, SteeringCurve) == 0x000378, "Member 'UWheeledVehicleMovementComponentNW::SteeringCurve' has a wrong offset!");
