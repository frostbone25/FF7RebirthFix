...
static_assert(sizeof(UAnimBoneCompressionCodec_ACL) == 0x000048, "Wrong size on UAnimBoneCompressionCodec_ACL");
static_assert(offsetof(UAnimBoneCompressionCodec_ACL, SafetyFallbackCodec) == 0x000040, "Member 'UAnimBoneCompressionCodec_ACL::SafetyFallbackCodec' has a wrong offset!");
