...
// Enum Niagara.EVfxCollisionObjectType
// NumValues: 0x0004
enum class EVfxCollisionObjectType : uint8
{
	Default                                  = 0,
	Character                                = 1,
	Environment                              = 2,
...
// Enum Niagara.EVfxExtraRenderPass
// NumValues: 0x0008
enum class EVfxExtraRenderPass : uint8
{
	ERP_None                                 = 0,
	ERP_FakeDecal                            = 1,
	ERP_Water                                = 2,
	ERP_Blur                                 = 3,
	ERP_ExtraGlare                           = 4,
	ERP_CompositeBackground                  = 5,
	ERP_CompositeForeground                  = 6,
	ERP_MAX                                  = 7,
};

// Enum Niagara.EVfxMaterialVABKind
// NumValues: 0x0005
enum class EVfxMaterialVABKind : uint8
{
	None                                     = 0,
	Rigid                                    = 1,
	Soft                                     = 2,
	Fluid                                    = 3,
	EVfxMaterialVABKind_MAX                  = 4,
};

// Enum Niagara.EVfxMaterialParameterFlags
// NumValues: 0x000B
enum class EVfxMaterialParameterFlags : uint32
{
	None                                     = 0,
	ParticleIdentifier_                      = 1,
	ParticleEmit_                            = 2,
	ParticleCoverage_                        = 4,
	ParticleCoordinate_                      = 8,
	ParticleDistortion_                      = 16,
	ParticleLit_                             = 32,
	ParticleSoft_                            = 64,
	Distortion_                              = 1048576,
	Visibility_                              = 2097152,
	EVfxMaterialParameterFlags_MAX           = 2097153,
};
...
enum class ENiagaraScriptTemplateSpecification : uint8
{
	...
	Behavior                                 = 2,
	VFX_Resident                             = 10,
	ENiagaraScriptTemplateSpecification_MAX  = 11,
};
...
public:
	...
	struct FVector                                LWCTile;                                           // 0x0010(0x000C)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<class UObject*>                        UObjects;                                          // 0x0050(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraPositionSource>         OriginalPositionData;                              // 0x0060(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FNiagaraParameterStore) == 0x000098, "Wrong size on FNiagaraParameterStore");
...
static_assert(offsetof(FNiagaraParameterStore, UObjects) == 0x000050, "Member 'FNiagaraParameterStore::UObjects' has a wrong offset!");
static_assert(offsetof(FNiagaraParameterStore, OriginalPositionData) == 0x000060, "Member 'FNiagaraParameterStore::OriginalPositionData' has a wrong offset!");
...
{
public:
	int32                                         ParameterSize;                                     // 0x0098(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        PaddedParameterSize;                               // 0x009C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraScriptExecutionPaddingInfo> PaddingInfo;                                       // 0x00A0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         bInitialized : 1;                                  // 0x00B0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FNiagaraScriptExecutionParameterStore) == 0x0000B8, "Wrong size on FNiagaraScriptExecutionParameterStore");
static_assert(offsetof(FNiagaraScriptExecutionParameterStore, ParameterSize) == 0x000098, "Member 'FNiagaraScriptExecutionParameterStore::ParameterSize' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptExecutionParameterStore, PaddedParameterSize) == 0x00009C, "Member 'FNiagaraScriptExecutionParameterStore::PaddedParameterSize' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptExecutionParameterStore, PaddingInfo) == 0x0000A0, "Member 'FNiagaraScriptExecutionParameterStore::PaddingInfo' has a wrong offset!");
...
public:
	...
	TArray<uint16>                                ComponentMappingsToDataBuffer;                     // 0x0028(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	TArray<uint16>                                ComponentMappingsFromDataBuffer;                   // 0x0038(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraSimCacheDataBuffersLayout) == 0x000008, "Wrong alignment on FNiagaraSimCacheDataBuffersLayout");
static_assert(sizeof(FNiagaraSimCacheDataBuffersLayout) == 0x000048, "Wrong size on FNiagaraSimCacheDataBuffersLayout");
...
static_assert(offsetof(FNiagaraSimCacheDataBuffersLayout, ComponentMappingsToDataBuffer) == 0x000028, "Member 'FNiagaraSimCacheDataBuffersLayout::ComponentMappingsToDataBuffer' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheDataBuffersLayout, ComponentMappingsFromDataBuffer) == 0x000038, "Member 'FNiagaraSimCacheDataBuffersLayout::ComponentMappingsFromDataBuffer' has a wrong offset!");
...
static_assert(sizeof(FEmitterCompiledScriptPair) == 0x0000A8, "Wrong size on FEmitterCompiledScriptPair");
...
{
public:
	struct FNiagaraVariable                       EmitterSpawnIntervalVar;                           // 0x0000(0x0020)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraVariable                       EmitterInterpSpawnStartDTVar;                      // 0x0020(0x0020)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraVariable                       EmitterSpawnGroupVar;                              // 0x0040(0x0020)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraVariable                       EmitterAgeVar;                                     // 0x0060(0x0020)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraVariable                       EmitterRandomSeedVar;                              // 0x0080(0x0020)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraVariable                       EmitterInstanceSeedVar;                            // 0x00A0(0x0020)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraVariable                       EmitterTotalSpawnedParticlesVar;                   // 0x00C0(0x0020)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraVariable                       m_VfxMaterialIndependentParameter_InstanceSeedVar; // 0x00E0(0x0020)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraDataSetCompiledData            DataSetCompiledData;                               // 0x0100(0x0048)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraEmitterCompiledData) == 0x000008, "Wrong alignment on FNiagaraEmitterCompiledData");
static_assert(sizeof(FNiagaraEmitterCompiledData) == 0x000148, "Wrong size on FNiagaraEmitterCompiledData");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterSpawnIntervalVar) == 0x000000, "Member 'FNiagaraEmitterCompiledData::EmitterSpawnIntervalVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterInterpSpawnStartDTVar) == 0x000020, "Member 'FNiagaraEmitterCompiledData::EmitterInterpSpawnStartDTVar' has a wrong offset!");
...
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterAgeVar) == 0x000060, "Member 'FNiagaraEmitterCompiledData::EmitterAgeVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterRandomSeedVar) == 0x000080, "Member 'FNiagaraEmitterCompiledData::EmitterRandomSeedVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterInstanceSeedVar) == 0x0000A0, "Member 'FNiagaraEmitterCompiledData::EmitterInstanceSeedVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterTotalSpawnedParticlesVar) == 0x0000C0, "Member 'FNiagaraEmitterCompiledData::EmitterTotalSpawnedParticlesVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, m_VfxMaterialIndependentParameter_InstanceSeedVar) == 0x0000E0, "Member 'FNiagaraEmitterCompiledData::m_VfxMaterialIndependentParameter_InstanceSeedVar' has a wrong offset!");
...
public:
	...
	class UTexture2D*                             IconOverride;                                      // 0x0008(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FLinearColor                           m_ConstantValue;                                   // 0x0020(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture*                               m_Texture;                                         // 0x0030(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UShaderResourceBuffer*                  m_ShaderResourceBuffer;                            // 0x0038(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         m_bIsStatic : 1;                                   // 0x0040(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         m_bIsDynamic : 1;                                  // 0x0040(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         m_bIsTexture : 1;                                  // 0x0040(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         m_bIsBuffer : 1;                                   // 0x0040(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         m_bIsResidentResource : 1;                         // 0x0040(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(FNiagaraMaterialAttributeBinding, m_ConstantValue) == 0x000020, "Member 'FNiagaraMaterialAttributeBinding::m_ConstantValue' has a wrong offset!");
static_assert(offsetof(FNiagaraMaterialAttributeBinding, m_Texture) == 0x000030, "Member 'FNiagaraMaterialAttributeBinding::m_Texture' has a wrong offset!");
static_assert(offsetof(FNiagaraMaterialAttributeBinding, m_ShaderResourceBuffer) == 0x000038, "Member 'FNiagaraMaterialAttributeBinding::m_ShaderResourceBuffer' has a wrong offset!");
...
public:
	...
	struct FNiagaraVariable                       DataSetVariable;                                   // 0x0030(0x0020)(Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	TArray<class UNiagaraSystem*>                 SystemSimsToRecache;                               // 0x0040(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
...
// 0x0018 (0x0018 - 0x0000)
struct alignas(0x08) FNiagaraTypeDefinition final
{
public:
...
static_assert(offsetof(FNiagaraScriptDataInterfaceCompileInfo, RegisteredParameterMapRead) == 0x000028, "Member 'FNiagaraScriptDataInterfaceCompileInfo::RegisteredParameterMapRead' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptDataInterfaceCompileInfo, RegisteredParameterMapWrite) == 0x000030, "Member 'FNiagaraScriptDataInterfaceCompileInfo::RegisteredParameterMapWrite' has a wrong offset!");
...
public:
	...
	class UNiagaraDataInterface*                  ResolvedDataInterface;                             // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FNCPool) == 0x0000A0, "Wrong size on FNCPool");
...
public:
	...
	struct FNiagaraTypeDefinition                 PropertyType;                                      // 0x0060(0x0018)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   MetadataSetterName;                                // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FString, class FString>            PropertySetterParameterDefaults;                   // 0x0080(0x0050)(NativeAccessSpecifierPublic)
	struct FNiagaraVariable                       WritableValue;                                     // 0x00D0(0x0020)(Transient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraComponentPropertyBinding) == 0x000008, "Wrong alignment on FNiagaraComponentPropertyBinding");
static_assert(sizeof(FNiagaraComponentPropertyBinding) == 0x0000F0, "Wrong size on FNiagaraComponentPropertyBinding");
...
static_assert(offsetof(FNiagaraComponentPropertyBinding, PropertySetterParameterDefaults) == 0x000080, "Member 'FNiagaraComponentPropertyBinding::PropertySetterParameterDefaults' has a wrong offset!");
static_assert(offsetof(FNiagaraComponentPropertyBinding, WritableValue) == 0x0000D0, "Member 'FNiagaraComponentPropertyBinding::WritableValue' has a wrong offset!");
...
public:
	...
	bool                                          bSystemShowActiveOnlyInWorld;                      // 0x0089(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowSystemVariables;                              // 0x008A(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FNiagaraDebugHudTextOptions            SystemTextOptions;                                 // 0x00A0(0x0010)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FNiagaraDebugHudTextOptions            ParticleTextOptions;                               // 0x00C8(0x0010)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bShowParticlesVariablesWithSystem;                 // 0x00D8(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowParticleVariablesVertical;                    // 0x00D9(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseMaxParticlesToDisplay;                         // 0x00DA(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseParticleDisplayClip;                           // 0x00DB(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              ParticleDisplayClip;                               // 0x00DC(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseParticleDisplayCenterRadius;                   // 0x00E4(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E5[0x3];                                       // 0x00E5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ParticleDisplayCenterRadius;                       // 0x00E8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MaxParticlesToDisplay;                             // 0x00EC(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PerfReportFrames;                                  // 0x00F0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraDebugHUDPerfSampleMode                PerfSampleMode;                                    // 0x00F4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraDebugHUDPerfGraphMode                 PerfGraphMode;                                     // 0x00F8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PerfHistoryFrames;                                 // 0x00FC(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PerfGraphTimeRange;                                // 0x0100(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              PerfGraphSize;                                     // 0x0104(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           PerfGraphAxisColor;                                // 0x010C(0x0010)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableSmoothing;                                  // 0x011C(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11D[0x3];                                      // 0x011D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         SmoothingWidth;                                    // 0x0120(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           DefaultBackgroundColor;                            // 0x0124(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           OverviewHeadingColor;                              // 0x0134(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           OverviewDetailColor;                               // 0x0144(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           OverviewDetailHighlightColor;                      // 0x0154(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           InWorldErrorTextColor;                             // 0x0164(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           InWorldTextColor;                                  // 0x0174(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           MessageInfoTextColor;                              // 0x0184(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           MessageWarningTextColor;                           // 0x0194(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           MessageErrorTextColor;                             // 0x01A4(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SystemColorTableOpacity;                           // 0x01B4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        SystemColorSeed;                                   // 0x01B8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                SystemColorHSVMin;                                 // 0x01BC(0x000C)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                SystemColorHSVMax;                                 // 0x01C8(0x000C)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraDebugPlaybackMode                     PlaybackMode;                                      // 0x01D4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPlaybackRateEnabled;                              // 0x01D5(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D6[0x2];                                      // 0x01D6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PlaybackRate;                                      // 0x01D8(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bLoopTimeEnabled;                                  // 0x01DC(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DD[0x3];                                      // 0x01DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         LoopTime;                                          // 0x01E0(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowGlobalBudgetInfo;                             // 0x01E4(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FNiagaraDebugHUDSettingsData) == 0x0001E8, "Wrong size on FNiagaraDebugHUDSettingsData");
...
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bSystemShowActiveOnlyInWorld) == 0x000089, "Member 'FNiagaraDebugHUDSettingsData::bSystemShowActiveOnlyInWorld' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowSystemVariables) == 0x00008A, "Member 'FNiagaraDebugHUDSettingsData::bShowSystemVariables' has a wrong offset!");
...
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowParticlesVariablesWithSystem) == 0x0000D8, "Member 'FNiagaraDebugHUDSettingsData::bShowParticlesVariablesWithSystem' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowParticleVariablesVertical) == 0x0000D9, "Member 'FNiagaraDebugHUDSettingsData::bShowParticleVariablesVertical' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bUseMaxParticlesToDisplay) == 0x0000DA, "Member 'FNiagaraDebugHUDSettingsData::bUseMaxParticlesToDisplay' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bUseParticleDisplayClip) == 0x0000DB, "Member 'FNiagaraDebugHUDSettingsData::bUseParticleDisplayClip' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, ParticleDisplayClip) == 0x0000DC, "Member 'FNiagaraDebugHUDSettingsData::ParticleDisplayClip' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bUseParticleDisplayCenterRadius) == 0x0000E4, "Member 'FNiagaraDebugHUDSettingsData::bUseParticleDisplayCenterRadius' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, ParticleDisplayCenterRadius) == 0x0000E8, "Member 'FNiagaraDebugHUDSettingsData::ParticleDisplayCenterRadius' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MaxParticlesToDisplay) == 0x0000EC, "Member 'FNiagaraDebugHUDSettingsData::MaxParticlesToDisplay' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfReportFrames) == 0x0000F0, "Member 'FNiagaraDebugHUDSettingsData::PerfReportFrames' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfSampleMode) == 0x0000F4, "Member 'FNiagaraDebugHUDSettingsData::PerfSampleMode' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphMode) == 0x0000F8, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphMode' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfHistoryFrames) == 0x0000FC, "Member 'FNiagaraDebugHUDSettingsData::PerfHistoryFrames' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphTimeRange) == 0x000100, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphTimeRange' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphSize) == 0x000104, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphSize' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphAxisColor) == 0x00010C, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphAxisColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bEnableSmoothing) == 0x00011C, "Member 'FNiagaraDebugHUDSettingsData::bEnableSmoothing' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SmoothingWidth) == 0x000120, "Member 'FNiagaraDebugHUDSettingsData::SmoothingWidth' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, DefaultBackgroundColor) == 0x000124, "Member 'FNiagaraDebugHUDSettingsData::DefaultBackgroundColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, OverviewHeadingColor) == 0x000134, "Member 'FNiagaraDebugHUDSettingsData::OverviewHeadingColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, OverviewDetailColor) == 0x000144, "Member 'FNiagaraDebugHUDSettingsData::OverviewDetailColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, OverviewDetailHighlightColor) == 0x000154, "Member 'FNiagaraDebugHUDSettingsData::OverviewDetailHighlightColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, InWorldErrorTextColor) == 0x000164, "Member 'FNiagaraDebugHUDSettingsData::InWorldErrorTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, InWorldTextColor) == 0x000174, "Member 'FNiagaraDebugHUDSettingsData::InWorldTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MessageInfoTextColor) == 0x000184, "Member 'FNiagaraDebugHUDSettingsData::MessageInfoTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MessageWarningTextColor) == 0x000194, "Member 'FNiagaraDebugHUDSettingsData::MessageWarningTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MessageErrorTextColor) == 0x0001A4, "Member 'FNiagaraDebugHUDSettingsData::MessageErrorTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorTableOpacity) == 0x0001B4, "Member 'FNiagaraDebugHUDSettingsData::SystemColorTableOpacity' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorSeed) == 0x0001B8, "Member 'FNiagaraDebugHUDSettingsData::SystemColorSeed' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorHSVMin) == 0x0001BC, "Member 'FNiagaraDebugHUDSettingsData::SystemColorHSVMin' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorHSVMax) == 0x0001C8, "Member 'FNiagaraDebugHUDSettingsData::SystemColorHSVMax' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PlaybackMode) == 0x0001D4, "Member 'FNiagaraDebugHUDSettingsData::PlaybackMode' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bPlaybackRateEnabled) == 0x0001D5, "Member 'FNiagaraDebugHUDSettingsData::bPlaybackRateEnabled' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PlaybackRate) == 0x0001D8, "Member 'FNiagaraDebugHUDSettingsData::PlaybackRate' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bLoopTimeEnabled) == 0x0001DC, "Member 'FNiagaraDebugHUDSettingsData::bLoopTimeEnabled' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, LoopTime) == 0x0001E0, "Member 'FNiagaraDebugHUDSettingsData::LoopTime' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowGlobalBudgetInfo) == 0x0001E4, "Member 'FNiagaraDebugHUDSettingsData::bShowGlobalBudgetInfo' has a wrong offset!");
...
public:
	...
	struct FFilePath                              ScriptAsset;                                       // 0x0050(0x0010)(NativeAccessSpecifierPublic)
	...
	uint8                                         bInterpolatedSpawning : 1;                         // 0x0068(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_69[0x3];                                       // 0x0069(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	ENiagaraSimTarget                             SimTarget;                                         // 0x006C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraEmitterCalculateBoundMode             CalculateBoundsMode;                               // 0x006D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6E[0x2];                                       // 0x006E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FBox                                   FixedBounds;                                       // 0x0070(0x001C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         bRequiresPersistentIDs : 1;                        // 0x008C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bCombineEventSpawn : 1;                            // 0x008C(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_8D[0x3];                                       // 0x008D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FNiagaraEventScriptProperties>  EventHandlerScriptProps;                           // 0x0090(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FNiagaraPlatformSet                    Platforms;                                         // 0x00A0(0x0030)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraEmitterScalabilityOverrides    ScalabilityOverrides;                              // 0x00D0(0x0010)(Edit, NativeAccessSpecifierPublic)
	uint8                                         bLimitDeltaTime : 1;                               // 0x00E0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	float                                         MaxDeltaTimePerTick;                               // 0x00E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EParticleAllocationMode                       AllocationMode;                                    // 0x00EC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_ED[0x3];                                       // 0x00ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PreAllocationCount;                                // 0x00F0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F4[0x4];                                       // 0x00F4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraEmitterScriptProperties        UpdateScriptProps;                                 // 0x00F8(0x0028)(NativeAccessSpecifierPublic)
	struct FNiagaraEmitterScriptProperties        SpawnScriptProps;                                  // 0x0120(0x0028)(NativeAccessSpecifierPublic)
	struct FNiagaraParameterStore                 RendererBindings;                                  // 0x0148(0x0098)(NativeAccessSpecifierPublic)
	TArray<class UNiagaraRendererProperties*>     RendererProperties;                                // 0x01E0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<class UNiagaraSimulationStageBase*>    SimulationStages;                                  // 0x01F0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class UNiagaraScript*                         GPUComputeScript;                                  // 0x0200(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class FName>                           SharedEventGeneratorIds;                           // 0x0208(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	struct FNiagaraEmitterScalabilitySettings     CurrentScalabilitySettings;                        // 0x0218(0x0038)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_250[0x98];                                     // 0x0250(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FVersionedNiagaraEmitterData, bLocalSpace) == 0x000060, "Member 'FVersionedNiagaraEmitterData::bLocalSpace' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, bDeterminism) == 0x000061, "Member 'FVersionedNiagaraEmitterData::bDeterminism' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, RandomSeed) == 0x000064, "Member 'FVersionedNiagaraEmitterData::RandomSeed' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, SimTarget) == 0x00006C, "Member 'FVersionedNiagaraEmitterData::SimTarget' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, CalculateBoundsMode) == 0x00006D, "Member 'FVersionedNiagaraEmitterData::CalculateBoundsMode' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, FixedBounds) == 0x000070, "Member 'FVersionedNiagaraEmitterData::FixedBounds' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, EventHandlerScriptProps) == 0x000090, "Member 'FVersionedNiagaraEmitterData::EventHandlerScriptProps' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, Platforms) == 0x0000A0, "Member 'FVersionedNiagaraEmitterData::Platforms' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, ScalabilityOverrides) == 0x0000D0, "Member 'FVersionedNiagaraEmitterData::ScalabilityOverrides' has a wrong offset!");
...
static_assert(offsetof(FVersionedNiagaraEmitterData, MaxDeltaTimePerTick) == 0x0000E8, "Member 'FVersionedNiagaraEmitterData::MaxDeltaTimePerTick' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, AllocationMode) == 0x0000EC, "Member 'FVersionedNiagaraEmitterData::AllocationMode' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, PreAllocationCount) == 0x0000F0, "Member 'FVersionedNiagaraEmitterData::PreAllocationCount' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, UpdateScriptProps) == 0x0000F8, "Member 'FVersionedNiagaraEmitterData::UpdateScriptProps' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, SpawnScriptProps) == 0x000120, "Member 'FVersionedNiagaraEmitterData::SpawnScriptProps' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, RendererBindings) == 0x000148, "Member 'FVersionedNiagaraEmitterData::RendererBindings' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, RendererProperties) == 0x0001E0, "Member 'FVersionedNiagaraEmitterData::RendererProperties' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, SimulationStages) == 0x0001F0, "Member 'FVersionedNiagaraEmitterData::SimulationStages' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, GPUComputeScript) == 0x000200, "Member 'FVersionedNiagaraEmitterData::GPUComputeScript' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, SharedEventGeneratorIds) == 0x000208, "Member 'FVersionedNiagaraEmitterData::SharedEventGeneratorIds' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, CurrentScalabilitySettings) == 0x000218, "Member 'FVersionedNiagaraEmitterData::CurrentScalabilitySettings' has a wrong offset!");
...
{
public:
	class UNiagaraEmitter*                        Emitter;                                           // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FVector                                PivotOffset;                                       // 0x0020(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraMeshPivotOffsetSpace                  PivotOffsetSpace;                                  // 0x002C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FNiagaraMeshRendererMeshProperties) == 0x000030, "Wrong size on FNiagaraMeshRendererMeshProperties");
...
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, Rotation) == 0x000014, "Member 'FNiagaraMeshRendererMeshProperties::Rotation' has a wrong offset!");
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, PivotOffset) == 0x000020, "Member 'FNiagaraMeshRendererMeshProperties::PivotOffset' has a wrong offset!");
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, PivotOffsetSpace) == 0x00002C, "Member 'FNiagaraMeshRendererMeshProperties::PivotOffsetSpace' has a wrong offset!");
...
public:
	...
	struct FNiagaraVMExecutableByteCode           OptimizedByteCode;                                 // 0x0010(0x0018)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_28[0x10];                                      // 0x0028(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         NumTempRegisters;                                  // 0x0038(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumUserPtrs;                                       // 0x003C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<uint8>                                 ScriptLiterals;                                    // 0x0040(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraVariable>               Attributes;                                        // 0x0050(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FNiagaraScriptDataUsageInfo            DataUsage;                                         // 0x0060(0x0001)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FNiagaraShaderScriptParametersMetadata ShaderScriptParametersMetadata;                    // 0x00B8(0x0020)(NativeAccessSpecifierPublic)
	ENiagaraScriptCompileStatus                   LastCompileStatus;                                 // 0x00D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D9[0x7];                                       // 0x00D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FSimulationStageMetaData>       SimulationStageMetaData;                           // 0x00E0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<uint8>                                 ExperimentalContextData;                           // 0x00F0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         bReadsSignificanceIndex : 1;                       // 0x0100(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bNeedsGPUContextInit : 1;                          // 0x0100(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(FNiagaraVMExecutableData, NumTempRegisters) == 0x000038, "Member 'FNiagaraVMExecutableData::NumTempRegisters' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, NumUserPtrs) == 0x00003C, "Member 'FNiagaraVMExecutableData::NumUserPtrs' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, ScriptLiterals) == 0x000040, "Member 'FNiagaraVMExecutableData::ScriptLiterals' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, Attributes) == 0x000050, "Member 'FNiagaraVMExecutableData::Attributes' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, DataUsage) == 0x000060, "Member 'FNiagaraVMExecutableData::DataUsage' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, DataInterfaceInfo) == 0x000068, "Member 'FNiagaraVMExecutableData::DataInterfaceInfo' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, CalledVMExternalFunctions) == 0x000078, "Member 'FNiagaraVMExecutableData::CalledVMExternalFunctions' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, ReadDataSets) == 0x000098, "Member 'FNiagaraVMExecutableData::ReadDataSets' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, WriteDataSets) == 0x0000A8, "Member 'FNiagaraVMExecutableData::WriteDataSets' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, ShaderScriptParametersMetadata) == 0x0000B8, "Member 'FNiagaraVMExecutableData::ShaderScriptParametersMetadata' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, LastCompileStatus) == 0x0000D8, "Member 'FNiagaraVMExecutableData::LastCompileStatus' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, SimulationStageMetaData) == 0x0000E0, "Member 'FNiagaraVMExecutableData::SimulationStageMetaData' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, ExperimentalContextData) == 0x0000F0, "Member 'FNiagaraVMExecutableData::ExperimentalContextData' has a wrong offset!");
...
static_assert(sizeof(FNiagaraScriptInstanceParameterStore) == 0x0000A8, "Wrong size on FNiagaraScriptInstanceParameterStore");
...
{
public:
	struct FNiagaraSimCacheDataBuffersLayout      SystemLayout;                                      // 0x0000(0x0048)(NativeAccessSpecifierPublic)
	TArray<struct FNiagaraSimCacheDataBuffersLayout> EmitterLayouts;                                    // 0x0048(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraSimCacheLayout) == 0x000008, "Wrong alignment on FNiagaraSimCacheLayout");
static_assert(sizeof(FNiagaraSimCacheLayout) == 0x000058, "Wrong size on FNiagaraSimCacheLayout");
...
static_assert(offsetof(FNiagaraSimCacheLayout, EmitterLayouts) == 0x000048, "Member 'FNiagaraSimCacheLayout::EmitterLayouts' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraSimCacheDataBuffers            SystemDataBuffers;                                 // 0x0020(0x0050)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraSimCacheSystemFrame) == 0x000008, "Wrong alignment on FNiagaraSimCacheSystemFrame");
static_assert(sizeof(FNiagaraSimCacheSystemFrame) == 0x000070, "Wrong size on FNiagaraSimCacheSystemFrame");
...
public:
	...
	struct FNiagaraSimCacheDataBuffers            ParticleDataBuffers;                               // 0x0020(0x0050)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraSimCacheEmitterFrame) == 0x000008, "Wrong alignment on FNiagaraSimCacheEmitterFrame");
static_assert(sizeof(FNiagaraSimCacheEmitterFrame) == 0x000070, "Wrong size on FNiagaraSimCacheEmitterFrame");
...
{
public:
	struct FNiagaraSimCacheSystemFrame            SystemData;                                        // 0x0000(0x0070)(NativeAccessSpecifierPublic)
	TArray<struct FNiagaraSimCacheEmitterFrame>   EmitterData;                                       // 0x0070(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraSimCacheFrame) == 0x000008, "Wrong alignment on FNiagaraSimCacheFrame");
static_assert(sizeof(FNiagaraSimCacheFrame) == 0x000080, "Wrong size on FNiagaraSimCacheFrame");
static_assert(offsetof(FNiagaraSimCacheFrame, SystemData) == 0x000000, "Member 'FNiagaraSimCacheFrame::SystemData' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheFrame, EmitterData) == 0x000070, "Member 'FNiagaraSimCacheFrame::EmitterData' has a wrong offset!");
...
{
public:
	struct FNiagaraParameterStore                 InstanceParamStore;                                // 0x0000(0x0098)(NativeAccessSpecifierPublic)
	struct FNiagaraDataSetCompiledData            DataSetCompiledData;                               // 0x0098(0x0048)(NativeAccessSpecifierPublic)
	struct FNiagaraDataSetCompiledData            SpawnInstanceParamsDataSetCompiledData;            // 0x00E0(0x0048)(NativeAccessSpecifierPublic)
	struct FNiagaraDataSetCompiledData            UpdateInstanceParamsDataSetCompiledData;           // 0x0128(0x0048)(NativeAccessSpecifierPublic)
	struct FNiagaraParameterDataSetBindingCollection SpawnInstanceGlobalBinding;                        // 0x0170(0x0020)(NativeAccessSpecifierPublic)
	struct FNiagaraParameterDataSetBindingCollection SpawnInstanceSystemBinding;                        // 0x0190(0x0020)(NativeAccessSpecifierPublic)
	struct FNiagaraParameterDataSetBindingCollection SpawnInstanceOwnerBinding;                         // 0x01B0(0x0020)(NativeAccessSpecifierPublic)
	TArray<struct FNiagaraParameterDataSetBindingCollection> SpawnInstanceEmitterBindings;                      // 0x01D0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FNiagaraParameterDataSetBindingCollection UpdateInstanceGlobalBinding;                       // 0x01E0(0x0020)(NativeAccessSpecifierPublic)
	struct FNiagaraParameterDataSetBindingCollection UpdateInstanceSystemBinding;                       // 0x0200(0x0020)(NativeAccessSpecifierPublic)
	struct FNiagaraParameterDataSetBindingCollection UpdateInstanceOwnerBinding;                        // 0x0220(0x0020)(NativeAccessSpecifierPublic)
	TArray<struct FNiagaraParameterDataSetBindingCollection> UpdateInstanceEmitterBindings;                     // 0x0240(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraSystemCompiledData) == 0x000008, "Wrong alignment on FNiagaraSystemCompiledData");
static_assert(sizeof(FNiagaraSystemCompiledData) == 0x000250, "Wrong size on FNiagaraSystemCompiledData");
...
static_assert(offsetof(FNiagaraSystemCompiledData, DataSetCompiledData) == 0x000098, "Member 'FNiagaraSystemCompiledData::DataSetCompiledData' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, SpawnInstanceParamsDataSetCompiledData) == 0x0000E0, "Member 'FNiagaraSystemCompiledData::SpawnInstanceParamsDataSetCompiledData' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, UpdateInstanceParamsDataSetCompiledData) == 0x000128, "Member 'FNiagaraSystemCompiledData::UpdateInstanceParamsDataSetCompiledData' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, SpawnInstanceGlobalBinding) == 0x000170, "Member 'FNiagaraSystemCompiledData::SpawnInstanceGlobalBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, SpawnInstanceSystemBinding) == 0x000190, "Member 'FNiagaraSystemCompiledData::SpawnInstanceSystemBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, SpawnInstanceOwnerBinding) == 0x0001B0, "Member 'FNiagaraSystemCompiledData::SpawnInstanceOwnerBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, SpawnInstanceEmitterBindings) == 0x0001D0, "Member 'FNiagaraSystemCompiledData::SpawnInstanceEmitterBindings' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, UpdateInstanceGlobalBinding) == 0x0001E0, "Member 'FNiagaraSystemCompiledData::UpdateInstanceGlobalBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, UpdateInstanceSystemBinding) == 0x000200, "Member 'FNiagaraSystemCompiledData::UpdateInstanceSystemBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, UpdateInstanceOwnerBinding) == 0x000220, "Member 'FNiagaraSystemCompiledData::UpdateInstanceOwnerBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, UpdateInstanceEmitterBindings) == 0x000240, "Member 'FNiagaraSystemCompiledData::UpdateInstanceEmitterBindings' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UTexture2D*                             IconOverrideTrue;                                  // 0x0018(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             IconOverrideFalse;                                 // 0x0020(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct FNiagaraPosition final : public FVector
{
};
...
{
public:
	TMap<struct FNiagaraVariable, struct FNiagaraVariable> UserParameterRedirects;                            // 0x0098(0x0050)(NativeAccessSpecifierPrivate)
};
...
static_assert(sizeof(FNiagaraUserRedirectionParameterStore) == 0x0000E8, "Wrong size on FNiagaraUserRedirectionParameterStore");
static_assert(offsetof(FNiagaraUserRedirectionParameterStore, UserParameterRedirects) == 0x000098, "Member 'FNiagaraUserRedirectionParameterStore::UserParameterRedirects' has a wrong offset!");
