...
static_assert(sizeof(UMovieSceneTrack) == 0x000078, "Wrong size on UMovieSceneTrack");
...
static_assert(offsetof(UMovieSceneTrack, EvaluationFieldGuid) == 0x000058, "Member 'UMovieSceneTrack::EvaluationFieldGuid' has a wrong offset!");
static_assert(offsetof(UMovieSceneTrack, EvaluationField) == 0x000068, "Member 'UMovieSceneTrack::EvaluationField' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneNameableTrack) == 0x000078, "Wrong size on UMovieSceneNameableTrack");
...
public:
	...
	struct FMovieSceneFrameRange                  SectionRange;                                      // 0x0054(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FFrameNumber                           PreRollFrames;                                     // 0x0064(0x0004)(Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FFrameNumber                           PostRollFrames;                                    // 0x0068(0x0004)(Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         RowIndex;                                          // 0x006C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         OverlapPriority;                                   // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bIsActive : 1;                                     // 0x0074(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bIsLocked : 1;                                     // 0x0074(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_75[0x3];                                       // 0x0075(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         StartTime;                                         // 0x0078(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         EndTime;                                           // 0x007C(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PreRollTime;                                       // 0x0080(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PostrollTime;                                      // 0x0084(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         bIsInfinite : 1;                                   // 0x0088(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Deprecated, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_89[0x3];                                       // 0x0089(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bSupportsInfiniteRange;                            // 0x008C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FOptionalMovieSceneBlendType           BlendType;                                         // 0x008D(0x0002)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_8F[0x19];                                      // 0x008F(0x0019)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneSection) == 0x0000A8, "Wrong size on UMovieSceneSection");
static_assert(offsetof(UMovieSceneSection, EvalOptions) == 0x000050, "Member 'UMovieSceneSection::EvalOptions' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, SectionRange) == 0x000054, "Member 'UMovieSceneSection::SectionRange' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, PreRollFrames) == 0x000064, "Member 'UMovieSceneSection::PreRollFrames' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, PostRollFrames) == 0x000068, "Member 'UMovieSceneSection::PostRollFrames' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, RowIndex) == 0x00006C, "Member 'UMovieSceneSection::RowIndex' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, OverlapPriority) == 0x000070, "Member 'UMovieSceneSection::OverlapPriority' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, StartTime) == 0x000078, "Member 'UMovieSceneSection::StartTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, EndTime) == 0x00007C, "Member 'UMovieSceneSection::EndTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, PreRollTime) == 0x000080, "Member 'UMovieSceneSection::PreRollTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, PostrollTime) == 0x000084, "Member 'UMovieSceneSection::PostrollTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, bSupportsInfiniteRange) == 0x00008C, "Member 'UMovieSceneSection::bSupportsInfiniteRange' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, BlendType) == 0x00008D, "Member 'UMovieSceneSection::BlendType' has a wrong offset!");
...
{
public:
	bool                                          DefaultValue;                                      // 0x00A8(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneBoolChannel                 BoolCurve;                                         // 0x00B0(0x0090)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneBoolSection) == 0x000140, "Wrong size on UMovieSceneBoolSection");
static_assert(offsetof(UMovieSceneBoolSection, DefaultValue) == 0x0000A8, "Member 'UMovieSceneBoolSection::DefaultValue' has a wrong offset!");
static_assert(offsetof(UMovieSceneBoolSection, BoolCurve) == 0x0000B0, "Member 'UMovieSceneBoolSection::BoolCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSpawnSection) == 0x000148, "Wrong size on UMovieSceneSpawnSection");
...
public:
	...
	EMovieScenePlayerStatus                       Status;                                            // 0x0461(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	int32                                         CurrentNumLoops;                                   // 0x047C(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_580[0x68];                                     // 0x0580(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_610[0x80];                                     // 0x0610(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMovieSceneSequencePlayer, OnPlay) == 0x000410, "Member 'UMovieSceneSequencePlayer::OnPlay' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnPlayReverse) == 0x000420, "Member 'UMovieSceneSequencePlayer::OnPlayReverse' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnStop) == 0x000430, "Member 'UMovieSceneSequencePlayer::OnStop' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnPause) == 0x000440, "Member 'UMovieSceneSequencePlayer::OnPause' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnFinished) == 0x000450, "Member 'UMovieSceneSequencePlayer::OnFinished' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, Status) == 0x000461, "Member 'UMovieSceneSequencePlayer::Status' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, Sequence) == 0x000468, "Member 'UMovieSceneSequencePlayer::Sequence' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, StartTime) == 0x000470, "Member 'UMovieSceneSequencePlayer::StartTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, DurationFrames) == 0x000474, "Member 'UMovieSceneSequencePlayer::DurationFrames' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, DurationSubFrames) == 0x000478, "Member 'UMovieSceneSequencePlayer::DurationSubFrames' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, CurrentNumLoops) == 0x00047C, "Member 'UMovieSceneSequencePlayer::CurrentNumLoops' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackSettings) == 0x000480, "Member 'UMovieSceneSequencePlayer::PlaybackSettings' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, RootTemplateInstance) == 0x000498, "Member 'UMovieSceneSequencePlayer::RootTemplateInstance' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, NetSyncProps) == 0x0005E8, "Member 'UMovieSceneSequencePlayer::NetSyncProps' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackClient) == 0x0005F8, "Member 'UMovieSceneSequencePlayer::PlaybackClient' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, TickManager) == 0x000608, "Member 'UMovieSceneSequencePlayer::TickManager' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneBlenderSystem) == 0x000060, "Wrong size on UMovieSceneBlenderSystem");
...
public:
	...
	uint8                                         Pad_370[0xE8];                                     // 0x0370(0x00E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneEntitySystemLinker) == 0x000458, "Wrong size on UMovieSceneEntitySystemLinker");
static_assert(offsetof(UMovieSceneEntitySystemLinker, SystemGraph) == 0x000238, "Member 'UMovieSceneEntitySystemLinker::SystemGraph' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneRestorePreAnimatedStateSystem) == 0x000040, "Wrong size on UMovieSceneRestorePreAnimatedStateSystem");
...
static_assert(sizeof(UMovieSceneSpawnTrack) == 0x000098, "Wrong size on UMovieSceneSpawnTrack");
static_assert(offsetof(UMovieSceneSpawnTrack, Sections) == 0x000078, "Member 'UMovieSceneSpawnTrack::Sections' has a wrong offset!");
static_assert(offsetof(UMovieSceneSpawnTrack, ObjectGuid) == 0x000088, "Member 'UMovieSceneSpawnTrack::ObjectGuid' has a wrong offset!");
...
{
public:
	struct FMovieSceneSectionParameters           Parameters;                                        // 0x00A8(0x0024)(Edit, BlueprintVisible, Config, NoDestructor, NativeAccessSpecifierPublic)
	float                                         StartOffset;                                       // 0x00CC(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         TimeScale;                                         // 0x00D0(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         PreRollTime_MovieSceneSubSection;                  // 0x00D4(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMovieSceneSequence*                    SubSequence;                                       // 0x00D8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TLazyObjectPtr<class AActor>                  ActorToRecord;                                     // 0x00E0(0x001C)(Edit, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_FC[0x4];                                       // 0x00FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 TargetSequenceName;                                // 0x0100(0x0010)(Edit, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FDirectoryPath                         TargetPathToRecordTo;                              // 0x0110(0x0010)(Edit, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneSubSection) == 0x000120, "Wrong size on UMovieSceneSubSection");
static_assert(offsetof(UMovieSceneSubSection, Parameters) == 0x0000A8, "Member 'UMovieSceneSubSection::Parameters' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, StartOffset) == 0x0000CC, "Member 'UMovieSceneSubSection::StartOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, TimeScale) == 0x0000D0, "Member 'UMovieSceneSubSection::TimeScale' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, PreRollTime_MovieSceneSubSection) == 0x0000D4, "Member 'UMovieSceneSubSection::PreRollTime_MovieSceneSubSection' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, SubSequence) == 0x0000D8, "Member 'UMovieSceneSubSection::SubSequence' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, ActorToRecord) == 0x0000E0, "Member 'UMovieSceneSubSection::ActorToRecord' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, TargetSequenceName) == 0x000100, "Member 'UMovieSceneSubSection::TargetSequenceName' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, TargetPathToRecordTo) == 0x000110, "Member 'UMovieSceneSubSection::TargetPathToRecordTo' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSubTrack) == 0x000088, "Wrong size on UMovieSceneSubTrack");
static_assert(offsetof(UMovieSceneSubTrack, Sections) == 0x000078, "Member 'UMovieSceneSubTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UTestMovieSceneTrack) == 0x000098, "Wrong size on UTestMovieSceneTrack");
static_assert(offsetof(UTestMovieSceneTrack, bHighPassFilter) == 0x000080, "Member 'UTestMovieSceneTrack::bHighPassFilter' has a wrong offset!");
static_assert(offsetof(UTestMovieSceneTrack, SectionArray) == 0x000088, "Member 'UTestMovieSceneTrack::SectionArray' has a wrong offset!");
...
static_assert(sizeof(UTestMovieSceneSection) == 0x0000A8, "Wrong size on UTestMovieSceneSection");
...
static_assert(sizeof(UTestMovieSceneSubTrack) == 0x000098, "Wrong size on UTestMovieSceneSubTrack");
static_assert(offsetof(UTestMovieSceneSubTrack, SectionArray) == 0x000088, "Member 'UTestMovieSceneSubTrack::SectionArray' has a wrong offset!");
...
static_assert(sizeof(UTestMovieSceneSubSection) == 0x000120, "Wrong size on UTestMovieSceneSubSection");
