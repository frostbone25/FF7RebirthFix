...
#include "btsc_1300_JUNOA_JunonEastArea_mob_11_classes.hpp"
#include "btsc_1300_JUNOA_JunonEastArea_mob_11_parameters.hpp"
...
void Abtsc_1300_JUNOA_JunonEastArea_mob_11_C::OnEntryBattleScene(const class FName& battleScenenBPName, const class FName& territoryID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_1300-JUNOA_JunonEastArea_mob_11_C", "OnEntryBattleScene");

	Params::btsc_1300_JUNOA_JunonEastArea_mob_11_C_OnEntryBattleScene Parms{};
...
void Abtsc_1300_JUNOA_JunonEastArea_mob_11_C::OnTakeDamage(int32 Damage, const class FName& CauserCharaName, const class FName& DamagedCharaName, const class FName& AbilityId, bool bBind, bool bGuard, const class FName& hitBoneName, bool bAttributeHit, bool bResistHit, const class FName& DamageSourceID, EEndBattleAttributeType appendAttribute, float justHitRotYaw, const struct FVector& hitPosition, bool bHeal, bool bBurst, bool bLock)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_1300-JUNOA_JunonEastArea_mob_11_C", "OnTakeDamage");

	Params::btsc_1300_JUNOA_JunonEastArea_mob_11_C_OnTakeDamage Parms{};
...
void Abtsc_1300_JUNOA_JunonEastArea_mob_11_C::ExecuteUbergraph_btsc_1300_JUNOA_JunonEastArea_mob_11(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_1300-JUNOA_JunonEastArea_mob_11_C", "ExecuteUbergraph_btsc_1300-JUNOA_JunonEastArea_mob_11");

	Params::btsc_1300_JUNOA_JunonEastArea_mob_11_C_ExecuteUbergraph_btsc_1300_JUNOA_JunonEastArea_mob_11 Parms{};
