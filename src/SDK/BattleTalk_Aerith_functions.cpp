...
bool UBattleTalk_Aerith_C::OnNotify(const class FName& AnimName, const class FName& SoundName, class AEndCharacter* OwnerChara) const
{
...
bool UBattleTalk_Aerith_C::OnNotifyWithAbility(const class FName& AnimName, const class FName& SoundName, class AEndCharacter* OwnerChara, class AEndCharacter* targetChara, const class FName& AbilityId, const struct FEndDataObjectBattleAbilityAccessor& dataObjectBattleAbility, bool bFinishBlow) const
{
	static class UFunction* Func = nullptr;
