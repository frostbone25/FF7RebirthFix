...
// ScriptStruct PBIK.RigUnit_PBIK_WorkData
// 0x00A0 (0x00A0 - 0x0000)
struct FRigUnit_PBIK_WorkData final
{
public:
	TArray<int32>                                 EffectorSolverIndices;                             // 0x0000(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 BoneSettingToSolverBoneIndex;                      // 0x0010(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FCachedRigElement>              SolverBoneToElementIndex;                          // 0x0020(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FPBIKSolver                            Solver;                                            // 0x0030(0x0068)(NativeAccessSpecifierPublic)
	bool                                          bNeedsInit;                                        // 0x0098(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_99[0x7];                                       // 0x0099(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigUnit_PBIK_WorkData) == 0x000008, "Wrong alignment on FRigUnit_PBIK_WorkData");
static_assert(sizeof(FRigUnit_PBIK_WorkData) == 0x0000A0, "Wrong size on FRigUnit_PBIK_WorkData");
static_assert(offsetof(FRigUnit_PBIK_WorkData, EffectorSolverIndices) == 0x000000, "Member 'FRigUnit_PBIK_WorkData::EffectorSolverIndices' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK_WorkData, BoneSettingToSolverBoneIndex) == 0x000010, "Member 'FRigUnit_PBIK_WorkData::BoneSettingToSolverBoneIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK_WorkData, SolverBoneToElementIndex) == 0x000020, "Member 'FRigUnit_PBIK_WorkData::SolverBoneToElementIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK_WorkData, Solver) == 0x000030, "Member 'FRigUnit_PBIK_WorkData::Solver' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK_WorkData, bNeedsInit) == 0x000098, "Member 'FRigUnit_PBIK_WorkData::bNeedsInit' has a wrong offset!");
...
public:
	...
	TArray<struct FPBIKBoneSetting>               BoneSettings;                                      // 0x0080(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           ExcludedBones;                                     // 0x0090(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FPBIKSolverSettings                    Settings;                                          // 0x00A0(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	float                                         Weight;                                            // 0x00B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPBIKDebug                             Debug;                                             // 0x00B4(0x0008)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_BC[0x4];                                       // 0x00BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigUnit_PBIK_WorkData                 WorkData;                                          // 0x00C0(0x00A0)(Transient, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnit_PBIK) == 0x000008, "Wrong alignment on FRigUnit_PBIK");
static_assert(sizeof(FRigUnit_PBIK) == 0x000160, "Wrong size on FRigUnit_PBIK");
static_assert(offsetof(FRigUnit_PBIK, Root) == 0x000068, "Member 'FRigUnit_PBIK::Root' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, Effectors) == 0x000070, "Member 'FRigUnit_PBIK::Effectors' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, BoneSettings) == 0x000080, "Member 'FRigUnit_PBIK::BoneSettings' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, ExcludedBones) == 0x000090, "Member 'FRigUnit_PBIK::ExcludedBones' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, Settings) == 0x0000A0, "Member 'FRigUnit_PBIK::Settings' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, Weight) == 0x0000B0, "Member 'FRigUnit_PBIK::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, Debug) == 0x0000B4, "Member 'FRigUnit_PBIK::Debug' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, WorkData) == 0x0000C0, "Member 'FRigUnit_PBIK::WorkData' has a wrong offset!");
