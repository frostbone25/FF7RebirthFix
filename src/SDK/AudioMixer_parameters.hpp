...
static_assert(sizeof(QuartzClockHandle_SetBeatsPerMinute) == 0x000028, "Wrong size on QuartzClockHandle_SetBeatsPerMinute");
...
static_assert(offsetof(QuartzClockHandle_SetBeatsPerMinute, BeatsPerMinute) == 0x000024, "Member 'QuartzClockHandle_SetBeatsPerMinute::BeatsPerMinute' has a wrong offset!");
...
static_assert(sizeof(QuartzClockHandle_SetMillisecondsPerTick) == 0x000028, "Wrong size on QuartzClockHandle_SetMillisecondsPerTick");
...
static_assert(offsetof(QuartzClockHandle_SetMillisecondsPerTick, MillisecondsPerTick) == 0x000024, "Member 'QuartzClockHandle_SetMillisecondsPerTick::MillisecondsPerTick' has a wrong offset!");
...
static_assert(sizeof(QuartzClockHandle_SetSecondsPerTick) == 0x000028, "Wrong size on QuartzClockHandle_SetSecondsPerTick");
...
static_assert(offsetof(QuartzClockHandle_SetSecondsPerTick, SecondsPerTick) == 0x000024, "Member 'QuartzClockHandle_SetSecondsPerTick::SecondsPerTick' has a wrong offset!");
...
static_assert(sizeof(QuartzClockHandle_SetThirtySecondNotesPerMinute) == 0x000028, "Wrong size on QuartzClockHandle_SetThirtySecondNotesPerMinute");
...
static_assert(offsetof(QuartzClockHandle_SetThirtySecondNotesPerMinute, ThirtySecondsNotesPerMinute) == 0x000024, "Member 'QuartzClockHandle_SetThirtySecondNotesPerMinute::ThirtySecondsNotesPerMinute' has a wrong offset!");
...
static_assert(sizeof(QuartzClockHandle_SetTicksPerSecond) == 0x000028, "Wrong size on QuartzClockHandle_SetTicksPerSecond");
...
static_assert(offsetof(QuartzClockHandle_SetTicksPerSecond, TicksPerSecond) == 0x000024, "Member 'QuartzClockHandle_SetTicksPerSecond::TicksPerSecond' has a wrong offset!");
...
static_assert(sizeof(QuartzClockHandle_SubscribeToAllQuantizationEvents) == 0x000018, "Wrong size on QuartzClockHandle_SubscribeToAllQuantizationEvents");
