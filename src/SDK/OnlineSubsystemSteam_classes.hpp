...
public:
	...
	uint8                                         Pad_1B91[0x7];                                     // 0x1B91(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USteamNetConnection) == 0x001B98, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x001B90, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
