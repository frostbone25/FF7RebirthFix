...
{
public:
	TArray<struct FBoolParameterNameAndCurve>     BoolParameterNamesAndCurves;                       // 0x00A8(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FScalarParameterNameAndCurve>   ScalarParameterNamesAndCurves;                     // 0x00B8(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FVector2DParameterNameAndCurves> Vector2DParameterNamesAndCurves;                   // 0x00C8(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FVectorParameterNameAndCurves>  VectorParameterNamesAndCurves;                     // 0x00D8(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FColorParameterNameAndCurves>   ColorParameterNamesAndCurves;                      // 0x00E8(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FTransformParameterNameAndCurves> TransformParameterNamesAndCurves;                  // 0x00F8(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneParameterSection) == 0x000108, "Wrong size on UMovieSceneParameterSection");
static_assert(offsetof(UMovieSceneParameterSection, BoolParameterNamesAndCurves) == 0x0000A8, "Member 'UMovieSceneParameterSection::BoolParameterNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneParameterSection, ScalarParameterNamesAndCurves) == 0x0000B8, "Member 'UMovieSceneParameterSection::ScalarParameterNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneParameterSection, Vector2DParameterNamesAndCurves) == 0x0000C8, "Member 'UMovieSceneParameterSection::Vector2DParameterNamesAndCurves' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneParameterSection, TransformParameterNamesAndCurves) == 0x0000F8, "Member 'UMovieSceneParameterSection::TransformParameterNamesAndCurves' has a wrong offset!");
...
{
public:
	struct FMovieSceneSkeletalAnimationParams     Params_0;                                          // 0x00A8(0x00E0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class UAnimSequence*                          AnimSequence;                                      // 0x0188(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UAnimSequenceBase*                      Animation;                                         // 0x0190(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         StartOffset;                                       // 0x0198(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         EndOffset;                                         // 0x019C(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         PlayRate;                                          // 0x01A0(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bReverse : 1;                                      // 0x01A4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_1A5[0x3];                                      // 0x01A5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SlotName;                                          // 0x01A8(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                StartLocationOffset;                               // 0x01B0(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               StartRotationOffset;                               // 0x01BC(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bMatchWithPrevious;                                // 0x01C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C9[0x3];                                      // 0x01C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   MatchedBoneName;                                   // 0x01CC(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                MatchedLocationOffset;                             // 0x01D4(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               MatchedRotationOffset;                             // 0x01E0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bMatchTranslation;                                 // 0x01EC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMatchIncludeZHeight;                              // 0x01ED(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMatchRotationYaw;                                 // 0x01EE(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMatchRotationPitch;                               // 0x01EF(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMatchRotationRoll;                                // 0x01F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneSkeletalAnimationSection) == 0x000240, "Wrong size on UMovieSceneSkeletalAnimationSection");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, Params_0) == 0x0000A8, "Member 'UMovieSceneSkeletalAnimationSection::Params_0' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, AnimSequence) == 0x000188, "Member 'UMovieSceneSkeletalAnimationSection::AnimSequence' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, Animation) == 0x000190, "Member 'UMovieSceneSkeletalAnimationSection::Animation' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, StartOffset) == 0x000198, "Member 'UMovieSceneSkeletalAnimationSection::StartOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, EndOffset) == 0x00019C, "Member 'UMovieSceneSkeletalAnimationSection::EndOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, PlayRate) == 0x0001A0, "Member 'UMovieSceneSkeletalAnimationSection::PlayRate' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, SlotName) == 0x0001A8, "Member 'UMovieSceneSkeletalAnimationSection::SlotName' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, StartLocationOffset) == 0x0001B0, "Member 'UMovieSceneSkeletalAnimationSection::StartLocationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, StartRotationOffset) == 0x0001BC, "Member 'UMovieSceneSkeletalAnimationSection::StartRotationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchWithPrevious) == 0x0001C8, "Member 'UMovieSceneSkeletalAnimationSection::bMatchWithPrevious' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MatchedBoneName) == 0x0001CC, "Member 'UMovieSceneSkeletalAnimationSection::MatchedBoneName' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MatchedLocationOffset) == 0x0001D4, "Member 'UMovieSceneSkeletalAnimationSection::MatchedLocationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MatchedRotationOffset) == 0x0001E0, "Member 'UMovieSceneSkeletalAnimationSection::MatchedRotationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchTranslation) == 0x0001EC, "Member 'UMovieSceneSkeletalAnimationSection::bMatchTranslation' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchIncludeZHeight) == 0x0001ED, "Member 'UMovieSceneSkeletalAnimationSection::bMatchIncludeZHeight' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchRotationYaw) == 0x0001EE, "Member 'UMovieSceneSkeletalAnimationSection::bMatchRotationYaw' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchRotationPitch) == 0x0001EF, "Member 'UMovieSceneSkeletalAnimationSection::bMatchRotationPitch' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchRotationRoll) == 0x0001F0, "Member 'UMovieSceneSkeletalAnimationSection::bMatchRotationRoll' has a wrong offset!");
...
static_assert(sizeof(UMovieScenePropertyTrack) == 0x0000A8, "Wrong size on UMovieScenePropertyTrack");
static_assert(offsetof(UMovieScenePropertyTrack, SectionToKey) == 0x000078, "Member 'UMovieScenePropertyTrack::SectionToKey' has a wrong offset!");
static_assert(offsetof(UMovieScenePropertyTrack, PropertyBinding) == 0x000080, "Member 'UMovieScenePropertyTrack::PropertyBinding' has a wrong offset!");
static_assert(offsetof(UMovieScenePropertyTrack, Sections) == 0x000098, "Member 'UMovieScenePropertyTrack::Sections' has a wrong offset!");
...
{
public:
	struct FMovieSceneFloatChannel                FloatCurve;                                        // 0x00A8(0x00A0)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneSlomoSection) == 0x000148, "Wrong size on UMovieSceneSlomoSection");
static_assert(offsetof(UMovieSceneSlomoSection, FloatCurve) == 0x0000A8, "Member 'UMovieSceneSlomoSection::FloatCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneBoolTrack) == 0x0000B0, "Wrong size on UMovieSceneBoolTrack");
...
{
public:
	struct FGuid                                  ConstraintId;                                      // 0x00A8(0x0010)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FMovieSceneObjectBindingID             ConstraintBindingID;                               // 0x00B8(0x0018)(Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieScene3DConstraintSection) == 0x0000D0, "Wrong size on UMovieScene3DConstraintSection");
static_assert(offsetof(UMovieScene3DConstraintSection, ConstraintId) == 0x0000A8, "Member 'UMovieScene3DConstraintSection::ConstraintId' has a wrong offset!");
static_assert(offsetof(UMovieScene3DConstraintSection, ConstraintBindingID) == 0x0000B8, "Member 'UMovieScene3DConstraintSection::ConstraintBindingID' has a wrong offset!");
...
public:
	...
	class FName                                   AttachSocketName;                                  // 0x00D8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   AttachComponentName;                               // 0x00E0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AttachmentLocationRule;                            // 0x00E8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AttachmentRotationRule;                            // 0x00E9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AttachmentScaleRule;                               // 0x00EA(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDetachmentRule                               DetachmentLocationRule;                            // 0x00EB(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDetachmentRule                               DetachmentRotationRule;                            // 0x00EC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDetachmentRule                               DetachmentScaleRule;                               // 0x00ED(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieScene3DAttachSection) == 0x0000F0, "Wrong size on UMovieScene3DAttachSection");
...
static_assert(offsetof(UMovieScene3DAttachSection, AttachmentLocationRule) == 0x0000E8, "Member 'UMovieScene3DAttachSection::AttachmentLocationRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, AttachmentRotationRule) == 0x0000E9, "Member 'UMovieScene3DAttachSection::AttachmentRotationRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, AttachmentScaleRule) == 0x0000EA, "Member 'UMovieScene3DAttachSection::AttachmentScaleRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, DetachmentLocationRule) == 0x0000EB, "Member 'UMovieScene3DAttachSection::DetachmentLocationRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, DetachmentRotationRule) == 0x0000EC, "Member 'UMovieScene3DAttachSection::DetachmentRotationRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, DetachmentScaleRule) == 0x0000ED, "Member 'UMovieScene3DAttachSection::DetachmentScaleRule' has a wrong offset!");
...
static_assert(sizeof(UMovieScene3DConstraintTrack) == 0x000088, "Wrong size on UMovieScene3DConstraintTrack");
static_assert(offsetof(UMovieScene3DConstraintTrack, ConstraintSections) == 0x000078, "Member 'UMovieScene3DConstraintTrack::ConstraintSections' has a wrong offset!");
...
static_assert(sizeof(UMovieScene3DAttachTrack) == 0x000088, "Wrong size on UMovieScene3DAttachTrack");
...
{
public:
	struct FMovieSceneFloatChannel                TimingCurve;                                       // 0x00D0(0x00A0)(NativeAccessSpecifierPublic)
	EMovieScene3DPathSection_Axis                 FrontAxisEnum;                                     // 0x0170(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMovieScene3DPathSection_Axis                 UpAxisEnum;                                        // 0x0171(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_172[0x2];                                      // 0x0172(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bFollow : 1;                                       // 0x0174(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReverse : 1;                                      // 0x0174(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bForceUpright : 1;                                 // 0x0174(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UMovieScene3DPathSection) == 0x000178, "Wrong size on UMovieScene3DPathSection");
static_assert(offsetof(UMovieScene3DPathSection, TimingCurve) == 0x0000D0, "Member 'UMovieScene3DPathSection::TimingCurve' has a wrong offset!");
static_assert(offsetof(UMovieScene3DPathSection, FrontAxisEnum) == 0x000170, "Member 'UMovieScene3DPathSection::FrontAxisEnum' has a wrong offset!");
static_assert(offsetof(UMovieScene3DPathSection, UpAxisEnum) == 0x000171, "Member 'UMovieScene3DPathSection::UpAxisEnum' has a wrong offset!");
...
static_assert(sizeof(UMovieScene3DPathTrack) == 0x000090, "Wrong size on UMovieScene3DPathTrack");
...
static_assert(sizeof(UMovieScenePropertySystem) == 0x000050, "Wrong size on UMovieScenePropertySystem");
static_assert(offsetof(UMovieScenePropertySystem, InstantiatorSystem) == 0x000040, "Member 'UMovieScenePropertySystem::InstantiatorSystem' has a wrong offset!");
...
static_assert(sizeof(UMovieScene3DTransformPropertySystem) == 0x000050, "Wrong size on UMovieScene3DTransformPropertySystem");
...
static_assert(sizeof(UMovieScenePropertyInstantiatorSystem) == 0x000290, "Wrong size on UMovieScenePropertyInstantiatorSystem");

// Class MovieSceneTracks.MovieScene3DTransformSection
// 0x0658 (0x0700 - 0x00A8)
class UMovieScene3DTransformSection final : public UMovieSceneSection
{
public:
	uint8                                         Pad_A8[0x8];                                       // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneTransformMask               TransformMask;                                     // 0x00B0(0x0004)(NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_B4[0x4];                                       // 0x00B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneFloatChannel                Translation[0x3];                                  // 0x00B8(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                Rotation[0x3];                                     // 0x0298(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                Scale[0x3];                                        // 0x0478(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                ManualWeight;                                      // 0x0658(0x00A0)(NativeAccessSpecifierPrivate)
	bool                                          bUseQuaternionInterpolation;                       // 0x06F8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieScene3DTransformSection) == 0x000700, "Wrong size on UMovieScene3DTransformSection");
static_assert(offsetof(UMovieScene3DTransformSection, TransformMask) == 0x0000B0, "Member 'UMovieScene3DTransformSection::TransformMask' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Translation) == 0x0000B8, "Member 'UMovieScene3DTransformSection::Translation' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Rotation) == 0x000298, "Member 'UMovieScene3DTransformSection::Rotation' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Scale) == 0x000478, "Member 'UMovieScene3DTransformSection::Scale' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, ManualWeight) == 0x000658, "Member 'UMovieScene3DTransformSection::ManualWeight' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, bUseQuaternionInterpolation) == 0x0006F8, "Member 'UMovieScene3DTransformSection::bUseQuaternionInterpolation' has a wrong offset!");
...
static_assert(sizeof(UMovieScene3DTransformTrack) == 0x0000A8, "Wrong size on UMovieScene3DTransformTrack");
...
static_assert(sizeof(UMovieSceneMaterialTrack) == 0x000088, "Wrong size on UMovieSceneMaterialTrack");
static_assert(offsetof(UMovieSceneMaterialTrack, Sections) == 0x000078, "Member 'UMovieSceneMaterialTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneMaterialParameterCollectionTrack) == 0x000098, "Wrong size on UMovieSceneMaterialParameterCollectionTrack");
static_assert(offsetof(UMovieSceneMaterialParameterCollectionTrack, MPC) == 0x000090, "Member 'UMovieSceneMaterialParameterCollectionTrack::MPC' has a wrong offset!");
...
{
public:
	struct FMovieSceneActorReferenceData          ActorReferenceData;                                // 0x00A8(0x00B0)(NativeAccessSpecifierPrivate)
	struct FIntegralCurve                         ActorGuidIndexCurve;                               // 0x0158(0x0080)(Deprecated, NativeAccessSpecifierPrivate)
	TArray<class FString>                         ActorGuidStrings;                                  // 0x01D8(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneActorReferenceSection) == 0x0001E8, "Wrong size on UMovieSceneActorReferenceSection");
static_assert(offsetof(UMovieSceneActorReferenceSection, ActorReferenceData) == 0x0000A8, "Member 'UMovieSceneActorReferenceSection::ActorReferenceData' has a wrong offset!");
static_assert(offsetof(UMovieSceneActorReferenceSection, ActorGuidIndexCurve) == 0x000158, "Member 'UMovieSceneActorReferenceSection::ActorGuidIndexCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneActorReferenceSection, ActorGuidStrings) == 0x0001D8, "Member 'UMovieSceneActorReferenceSection::ActorGuidStrings' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneActorReferenceTrack) == 0x0000B0, "Wrong size on UMovieSceneActorReferenceTrack");
...
static_assert(sizeof(UMovieSceneFloatPropertySystem) == 0x000050, "Wrong size on UMovieSceneFloatPropertySystem");
...
{
public:
	class USoundBase*                             Sound;                                             // 0x00A8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FFrameNumber                           StartFrameOffset;                                  // 0x00B0(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         StartOffset;                                       // 0x00B4(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         AudioStartTime;                                    // 0x00B8(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         AudioDilationFactor;                               // 0x00BC(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         AudioVolume;                                       // 0x00C0(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_C4[0x4];                                       // 0x00C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneFloatChannel                SoundVolume;                                       // 0x00C8(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                PitchMultiplier;                                   // 0x0168(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneActorReferenceData          AttachActorData;                                   // 0x0208(0x00B0)(NativeAccessSpecifierPrivate)
	bool                                          bLooping;                                          // 0x02B8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bSuppressSubtitles;                                // 0x02B9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bOverrideAttenuation;                              // 0x02BA(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2BB[0x5];                                      // 0x02BB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundAttenuation*                      AttenuationSettings;                               // 0x02C0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TDelegate<void(TArray<struct FSubtitleCue>& Subtitles, float CueDuration)> OnQueueSubtitles;                                  // 0x02C8(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void()>              OnAudioFinished;                                   // 0x02D8(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void(class USoundWave* PlayingSoundWave, float PlaybackPercent)> OnAudioPlaybackPercent;                            // 0x02E8(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneAudioSection) == 0x0002F8, "Wrong size on UMovieSceneAudioSection");
static_assert(offsetof(UMovieSceneAudioSection, Sound) == 0x0000A8, "Member 'UMovieSceneAudioSection::Sound' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, StartFrameOffset) == 0x0000B0, "Member 'UMovieSceneAudioSection::StartFrameOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, StartOffset) == 0x0000B4, "Member 'UMovieSceneAudioSection::StartOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AudioStartTime) == 0x0000B8, "Member 'UMovieSceneAudioSection::AudioStartTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AudioDilationFactor) == 0x0000BC, "Member 'UMovieSceneAudioSection::AudioDilationFactor' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AudioVolume) == 0x0000C0, "Member 'UMovieSceneAudioSection::AudioVolume' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, SoundVolume) == 0x0000C8, "Member 'UMovieSceneAudioSection::SoundVolume' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, PitchMultiplier) == 0x000168, "Member 'UMovieSceneAudioSection::PitchMultiplier' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AttachActorData) == 0x000208, "Member 'UMovieSceneAudioSection::AttachActorData' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bLooping) == 0x0002B8, "Member 'UMovieSceneAudioSection::bLooping' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bSuppressSubtitles) == 0x0002B9, "Member 'UMovieSceneAudioSection::bSuppressSubtitles' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bOverrideAttenuation) == 0x0002BA, "Member 'UMovieSceneAudioSection::bOverrideAttenuation' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AttenuationSettings) == 0x0002C0, "Member 'UMovieSceneAudioSection::AttenuationSettings' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnQueueSubtitles) == 0x0002C8, "Member 'UMovieSceneAudioSection::OnQueueSubtitles' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnAudioFinished) == 0x0002D8, "Member 'UMovieSceneAudioSection::OnAudioFinished' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnAudioPlaybackPercent) == 0x0002E8, "Member 'UMovieSceneAudioSection::OnAudioPlaybackPercent' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneFloatTrack) == 0x0000A8, "Wrong size on UMovieSceneFloatTrack");
...
static_assert(sizeof(UMovieSceneFadeTrack) == 0x0000B0, "Wrong size on UMovieSceneFadeTrack");
...
static_assert(sizeof(UMovieSceneAudioTrack) == 0x000090, "Wrong size on UMovieSceneAudioTrack");
static_assert(offsetof(UMovieSceneAudioTrack, AudioSections) == 0x000080, "Member 'UMovieSceneAudioTrack::AudioSections' has a wrong offset!");
...
{
public:
	struct FMovieSceneByteChannel                 ByteCurve;                                         // 0x00A8(0x0098)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneByteSection) == 0x000140, "Wrong size on UMovieSceneByteSection");
static_assert(offsetof(UMovieSceneByteSection, ByteCurve) == 0x0000A8, "Member 'UMovieSceneByteSection::ByteCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneByteTrack) == 0x0000B8, "Wrong size on UMovieSceneByteTrack");
static_assert(offsetof(UMovieSceneByteTrack, Enum) == 0x0000B0, "Member 'UMovieSceneByteTrack::Enum' has a wrong offset!");
...
{
public:
	struct FMovieSceneCameraAnimSectionData       AnimData;                                          // 0x00A8(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	class UCameraAnim*                            CameraAnim;                                        // 0x00C8(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         PlayRate;                                          // 0x00D0(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         PlayScale;                                         // 0x00D4(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         BlendInTime;                                       // 0x00D8(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         BlendOutTime;                                      // 0x00DC(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bLooping;                                          // 0x00E0(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneCameraAnimSection) == 0x0000E8, "Wrong size on UMovieSceneCameraAnimSection");
static_assert(offsetof(UMovieSceneCameraAnimSection, AnimData) == 0x0000A8, "Member 'UMovieSceneCameraAnimSection::AnimData' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraAnimSection, CameraAnim) == 0x0000C8, "Member 'UMovieSceneCameraAnimSection::CameraAnim' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraAnimSection, PlayRate) == 0x0000D0, "Member 'UMovieSceneCameraAnimSection::PlayRate' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraAnimSection, PlayScale) == 0x0000D4, "Member 'UMovieSceneCameraAnimSection::PlayScale' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraAnimSection, BlendInTime) == 0x0000D8, "Member 'UMovieSceneCameraAnimSection::BlendInTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraAnimSection, BlendOutTime) == 0x0000DC, "Member 'UMovieSceneCameraAnimSection::BlendOutTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraAnimSection, bLooping) == 0x0000E0, "Member 'UMovieSceneCameraAnimSection::bLooping' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraAnimTrack) == 0x000090, "Wrong size on UMovieSceneCameraAnimTrack");
static_assert(offsetof(UMovieSceneCameraAnimTrack, CameraAnimSections) == 0x000080, "Member 'UMovieSceneCameraAnimTrack::CameraAnimSections' has a wrong offset!");
...
public:
	uint8                                         Pad_A8[0x8];                                       // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bLockPreviousCamera;                               // 0x00B0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B1[0x3];                                       // 0x00B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  CameraGuid;                                        // 0x00B4(0x0010)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FMovieSceneObjectBindingID             CameraBindingID;                                   // 0x00C4(0x0018)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_DC[0x4];                                       // 0x00DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             InitialCameraCutTransform;                         // 0x00E0(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	bool                                          bHasInitialCameraCutTransform;                     // 0x0110(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneCameraCutSection, bLockPreviousCamera) == 0x0000B0, "Member 'UMovieSceneCameraCutSection::bLockPreviousCamera' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutSection, CameraGuid) == 0x0000B4, "Member 'UMovieSceneCameraCutSection::CameraGuid' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutSection, CameraBindingID) == 0x0000C4, "Member 'UMovieSceneCameraCutSection::CameraBindingID' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutSection, InitialCameraCutTransform) == 0x0000E0, "Member 'UMovieSceneCameraCutSection::InitialCameraCutTransform' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutSection, bHasInitialCameraCutTransform) == 0x000110, "Member 'UMovieSceneCameraCutSection::bHasInitialCameraCutTransform' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraCutTrack) == 0x000090, "Wrong size on UMovieSceneCameraCutTrack");
static_assert(offsetof(UMovieSceneCameraCutTrack, bCanBlend) == 0x000078, "Member 'UMovieSceneCameraCutTrack::bCanBlend' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutTrack, Sections) == 0x000080, "Member 'UMovieSceneCameraCutTrack::Sections' has a wrong offset!");
...
{
public:
	struct FMovieSceneCameraShakeSectionData      ShakeData;                                         // 0x00A8(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	TSubclassOf<class UMatineeCameraShake>        ShakeClass;                                        // 0x00C8(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayScale;                                         // 0x00D0(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECameraShakePlaySpace                         PlaySpace;                                         // 0x00D4(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D5[0x3];                                       // 0x00D5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               UserDefinedPlaySpace;                              // 0x00D8(0x000C)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneCameraShakeSection) == 0x0000E8, "Wrong size on UMovieSceneCameraShakeSection");
static_assert(offsetof(UMovieSceneCameraShakeSection, ShakeData) == 0x0000A8, "Member 'UMovieSceneCameraShakeSection::ShakeData' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraShakeSection, ShakeClass) == 0x0000C8, "Member 'UMovieSceneCameraShakeSection::ShakeClass' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraShakeSection, PlayScale) == 0x0000D0, "Member 'UMovieSceneCameraShakeSection::PlayScale' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraShakeSection, PlaySpace) == 0x0000D4, "Member 'UMovieSceneCameraShakeSection::PlaySpace' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraShakeSection, UserDefinedPlaySpace) == 0x0000D8, "Member 'UMovieSceneCameraShakeSection::UserDefinedPlaySpace' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraShakeSourceShakeSection) == 0x0000C8, "Wrong size on UMovieSceneCameraShakeSourceShakeSection");
static_assert(offsetof(UMovieSceneCameraShakeSourceShakeSection, ShakeData) == 0x0000A8, "Member 'UMovieSceneCameraShakeSourceShakeSection::ShakeData' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraShakeSourceShakeTrack) == 0x000090, "Wrong size on UMovieSceneCameraShakeSourceShakeTrack");
static_assert(offsetof(UMovieSceneCameraShakeSourceShakeTrack, CameraShakeSections) == 0x000080, "Member 'UMovieSceneCameraShakeSourceShakeTrack::CameraShakeSections' has a wrong offset!");
...
{
public:
	struct FMovieSceneCameraShakeSourceTriggerChannel Channel;                                           // 0x00A8(0x0088)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneCameraShakeSourceTriggerSection) == 0x000130, "Wrong size on UMovieSceneCameraShakeSourceTriggerSection");
static_assert(offsetof(UMovieSceneCameraShakeSourceTriggerSection, Channel) == 0x0000A8, "Member 'UMovieSceneCameraShakeSourceTriggerSection::Channel' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraShakeSourceTriggerTrack) == 0x000090, "Wrong size on UMovieSceneCameraShakeSourceTriggerTrack");
static_assert(offsetof(UMovieSceneCameraShakeSourceTriggerTrack, Sections) == 0x000080, "Member 'UMovieSceneCameraShakeSourceTriggerTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraShakeTrack) == 0x000090, "Wrong size on UMovieSceneCameraShakeTrack");
static_assert(offsetof(UMovieSceneCameraShakeTrack, CameraShakeSections) == 0x000080, "Member 'UMovieSceneCameraShakeTrack::CameraShakeSections' has a wrong offset!");
...
{
public:
	class FString                                 ShotDisplayName;                                   // 0x0120(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FText                                   DisplayName;                                       // 0x0130(0x0018)(Deprecated, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneCinematicShotSection) == 0x000148, "Wrong size on UMovieSceneCinematicShotSection");
static_assert(offsetof(UMovieSceneCinematicShotSection, ShotDisplayName) == 0x000120, "Member 'UMovieSceneCinematicShotSection::ShotDisplayName' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCinematicShotTrack) == 0x000088, "Wrong size on UMovieSceneCinematicShotTrack");
...
{
public:
	struct FMovieSceneFloatChannel                RedCurve;                                          // 0x00A8(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                GreenCurve;                                        // 0x0148(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                BlueCurve;                                         // 0x01E8(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                AlphaCurve;                                        // 0x0288(0x00A0)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneColorSection) == 0x000328, "Wrong size on UMovieSceneColorSection");
static_assert(offsetof(UMovieSceneColorSection, RedCurve) == 0x0000A8, "Member 'UMovieSceneColorSection::RedCurve' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneColorSection, BlueCurve) == 0x0001E8, "Member 'UMovieSceneColorSection::BlueCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneColorSection, AlphaCurve) == 0x000288, "Member 'UMovieSceneColorSection::AlphaCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneColorTrack) == 0x0000B8, "Wrong size on UMovieSceneColorTrack");
static_assert(offsetof(UMovieSceneColorTrack, bIsSlateColor) == 0x0000B0, "Member 'UMovieSceneColorTrack::bIsSlateColor' has a wrong offset!");
...
static_assert(sizeof(UMovieScenePreAnimatedComponentTransformSystem) == 0x0001C0, "Wrong size on UMovieScenePreAnimatedComponentTransformSystem");
...
static_assert(sizeof(UMovieSceneComponentTransformSystem) == 0x000050, "Wrong size on UMovieSceneComponentTransformSystem");
...
{
public:
	struct FMovieSceneByteChannel                 EnumCurve;                                         // 0x00A8(0x0098)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneEnumSection) == 0x000140, "Wrong size on UMovieSceneEnumSection");
static_assert(offsetof(UMovieSceneEnumSection, EnumCurve) == 0x0000A8, "Member 'UMovieSceneEnumSection::EnumCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEnumTrack) == 0x0000B8, "Wrong size on UMovieSceneEnumTrack");
static_assert(offsetof(UMovieSceneEnumTrack, Enum) == 0x0000B0, "Member 'UMovieSceneEnumTrack::Enum' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEulerTransformPropertySystem) == 0x000050, "Wrong size on UMovieSceneEulerTransformPropertySystem");
...
static_assert(sizeof(UMovieSceneEulerTransformTrack) == 0x0000A8, "Wrong size on UMovieSceneEulerTransformTrack");
...
static_assert(sizeof(UMovieSceneEventSectionBase) == 0x0000A8, "Wrong size on UMovieSceneEventSectionBase");
...
public:
	uint8                                         Pad_A8[0x8];                                       // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneEvent                       Event;                                             // 0x00B0(0x0028)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneEventRepeaterSection) == 0x0000D8, "Wrong size on UMovieSceneEventRepeaterSection");
static_assert(offsetof(UMovieSceneEventRepeaterSection, Event) == 0x0000B0, "Member 'UMovieSceneEventRepeaterSection::Event' has a wrong offset!");
...
{
public:
	struct FNameCurve                             Events;                                            // 0x00A8(0x0078)(Deprecated, NativeAccessSpecifierPrivate)
	struct FMovieSceneEventSectionData            EventData;                                         // 0x0120(0x0088)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneEventSection) == 0x0001A8, "Wrong size on UMovieSceneEventSection");
static_assert(offsetof(UMovieSceneEventSection, Events) == 0x0000A8, "Member 'UMovieSceneEventSection::Events' has a wrong offset!");
static_assert(offsetof(UMovieSceneEventSection, EventData) == 0x000120, "Member 'UMovieSceneEventSection::EventData' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEventTrack) == 0x000098, "Wrong size on UMovieSceneEventTrack");
static_assert(offsetof(UMovieSceneEventTrack, EventPosition) == 0x000084, "Member 'UMovieSceneEventTrack::EventPosition' has a wrong offset!");
static_assert(offsetof(UMovieSceneEventTrack, Sections) == 0x000088, "Member 'UMovieSceneEventTrack::Sections' has a wrong offset!");
...
public:
	uint8                                         Pad_A8[0x8];                                       // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneEventChannel                EventChannel;                                      // 0x00B0(0x0088)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneEventTriggerSection) == 0x000138, "Wrong size on UMovieSceneEventTriggerSection");
static_assert(offsetof(UMovieSceneEventTriggerSection, EventChannel) == 0x0000B0, "Member 'UMovieSceneEventTriggerSection::EventChannel' has a wrong offset!");
...
public:
	struct FMovieSceneFloatChannel                FloatCurve;                                        // 0x00A8(0x00A0)(NativeAccessSpecifierPublic)
	struct FLinearColor                           FadeColor;                                         // 0x0148(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieSceneFadeSection, FloatCurve) == 0x0000A8, "Member 'UMovieSceneFadeSection::FloatCurve' has a wrong offset!");
...
public:
	uint8                                         Pad_A8[0x8];                                       // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneFloatChannel                FloatCurve;                                        // 0x00B0(0x00A0)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneFloatSection) == 0x000150, "Wrong size on UMovieSceneFloatSection");
static_assert(offsetof(UMovieSceneFloatSection, FloatCurve) == 0x0000B0, "Member 'UMovieSceneFloatSection::FloatCurve' has a wrong offset!");
...
{
public:
	struct FMovieSceneIntegerChannel              IntegerCurve;                                      // 0x00A8(0x0090)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneIntegerSection) == 0x000138, "Wrong size on UMovieSceneIntegerSection");
static_assert(offsetof(UMovieSceneIntegerSection, IntegerCurve) == 0x0000A8, "Member 'UMovieSceneIntegerSection::IntegerCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneIntegerTrack) == 0x0000B0, "Wrong size on UMovieSceneIntegerTrack");
...
public:
	uint8                                         Pad_A8[0x8];                                       // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	ELevelVisibility                              Visibility;                                        // 0x00B0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_B1[0x7];                                       // 0x00B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           LevelNames;                                        // 0x00B8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneLevelVisibilitySection) == 0x0000C8, "Wrong size on UMovieSceneLevelVisibilitySection");
static_assert(offsetof(UMovieSceneLevelVisibilitySection, Visibility) == 0x0000B0, "Member 'UMovieSceneLevelVisibilitySection::Visibility' has a wrong offset!");
static_assert(offsetof(UMovieSceneLevelVisibilitySection, LevelNames) == 0x0000B8, "Member 'UMovieSceneLevelVisibilitySection::LevelNames' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneLevelVisibilityTrack) == 0x000088, "Wrong size on UMovieSceneLevelVisibilityTrack");
static_assert(offsetof(UMovieSceneLevelVisibilityTrack, Sections) == 0x000078, "Member 'UMovieSceneLevelVisibilityTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneComponentMaterialTrack) == 0x000098, "Wrong size on UMovieSceneComponentMaterialTrack");
static_assert(offsetof(UMovieSceneComponentMaterialTrack, MaterialIndex) == 0x000090, "Member 'UMovieSceneComponentMaterialTrack::MaterialIndex' has a wrong offset!");
...
{
public:
	struct FMovieSceneObjectPathChannel           ObjectChannel;                                     // 0x00A8(0x00C0)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneObjectPropertySection) == 0x000168, "Wrong size on UMovieSceneObjectPropertySection");
static_assert(offsetof(UMovieSceneObjectPropertySection, ObjectChannel) == 0x0000A8, "Member 'UMovieSceneObjectPropertySection::ObjectChannel' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneObjectPropertyTrack) == 0x0000B8, "Wrong size on UMovieSceneObjectPropertyTrack");
static_assert(offsetof(UMovieSceneObjectPropertyTrack, PropertyClass) == 0x0000B0, "Member 'UMovieSceneObjectPropertyTrack::PropertyClass' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneParticleParameterTrack) == 0x000090, "Wrong size on UMovieSceneParticleParameterTrack");
static_assert(offsetof(UMovieSceneParticleParameterTrack, Sections) == 0x000080, "Member 'UMovieSceneParticleParameterTrack::Sections' has a wrong offset!");
...
{
public:
	struct FMovieSceneParticleChannel             ParticleKeys;                                      // 0x00A8(0x0098)(NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieSceneParticleSection, ParticleKeys) == 0x0000A8, "Member 'UMovieSceneParticleSection::ParticleKeys' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneParticleTrack) == 0x000090, "Wrong size on UMovieSceneParticleTrack");
static_assert(offsetof(UMovieSceneParticleTrack, ParticleSections) == 0x000080, "Member 'UMovieSceneParticleTrack::ParticleSections' has a wrong offset!");
...
static_assert(sizeof(UMovieScenePiecewiseFloatBlenderSystem) == 0x000120, "Wrong size on UMovieScenePiecewiseFloatBlenderSystem");
...
{
public:
	struct FMovieSceneObjectPathChannel           MaterialChannel;                                   // 0x00A8(0x00C0)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieScenePrimitiveMaterialSection) == 0x000168, "Wrong size on UMovieScenePrimitiveMaterialSection");
static_assert(offsetof(UMovieScenePrimitiveMaterialSection, MaterialChannel) == 0x0000A8, "Member 'UMovieScenePrimitiveMaterialSection::MaterialChannel' has a wrong offset!");
...
static_assert(sizeof(UMovieScenePrimitiveMaterialTrack) == 0x0000B8, "Wrong size on UMovieScenePrimitiveMaterialTrack");
static_assert(offsetof(UMovieScenePrimitiveMaterialTrack, MaterialIndex) == 0x0000B0, "Member 'UMovieScenePrimitiveMaterialTrack::MaterialIndex' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneSkeletalAnimationTrack, AnimationSections) == 0x000080, "Member 'UMovieSceneSkeletalAnimationTrack::AnimationSections' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationTrack, bUseLegacySectionIndexBlend) == 0x000090, "Member 'UMovieSceneSkeletalAnimationTrack::bUseLegacySectionIndexBlend' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationTrack, RootMotionParams) == 0x000098, "Member 'UMovieSceneSkeletalAnimationTrack::RootMotionParams' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationTrack, bBlendFirstChildOfRoot) == 0x0000C8, "Member 'UMovieSceneSkeletalAnimationTrack::bBlendFirstChildOfRoot' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSlomoTrack) == 0x0000B0, "Wrong size on UMovieSceneSlomoTrack");
...
{
public:
	struct FMovieSceneStringChannel               StringCurve;                                       // 0x00A8(0x00A0)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneStringSection) == 0x000148, "Wrong size on UMovieSceneStringSection");
static_assert(offsetof(UMovieSceneStringSection, StringCurve) == 0x0000A8, "Member 'UMovieSceneStringSection::StringCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneStringTrack) == 0x0000B0, "Wrong size on UMovieSceneStringTrack");
...
static_assert(sizeof(UMovieSceneTransformTrack) == 0x0000A8, "Wrong size on UMovieSceneTransformTrack");
...
{
public:
	struct FMovieSceneFloatChannel                Curves[0x4];                                       // 0x00A8(0x00A0)(NativeAccessSpecifierPrivate)
	int32                                         ChannelsUsed;                                      // 0x0328(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneVectorSection) == 0x000330, "Wrong size on UMovieSceneVectorSection");
static_assert(offsetof(UMovieSceneVectorSection, Curves) == 0x0000A8, "Member 'UMovieSceneVectorSection::Curves' has a wrong offset!");
static_assert(offsetof(UMovieSceneVectorSection, ChannelsUsed) == 0x000328, "Member 'UMovieSceneVectorSection::ChannelsUsed' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneVectorTrack) == 0x0000B8, "Wrong size on UMovieSceneVectorTrack");
static_assert(offsetof(UMovieSceneVectorTrack, NumChannelsUsed) == 0x0000B0, "Member 'UMovieSceneVectorTrack::NumChannelsUsed' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneVisibilityTrack) == 0x0000B0, "Wrong size on UMovieSceneVisibilityTrack");
