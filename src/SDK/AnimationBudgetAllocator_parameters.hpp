...
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAnimationBudgetAllocatorParameters    InParameters;                                      // 0x0008(0x006C)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters) == 0x000078, "Wrong size on AnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters");
