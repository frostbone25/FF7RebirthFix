...
{
public:
	uint8                                         Pad_1AF0[0x50];                                    // 0x1AF0(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B44[0x4C];                                    // 0x1B44(0x004C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x001B90, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x001B40, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_780[0x38];                                     // 0x0780(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
