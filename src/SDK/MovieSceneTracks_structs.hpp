...
static_assert(sizeof(FMovieSceneVectorPropertySectionTemplate) == 0x0002C0, "Wrong size on FMovieSceneVectorPropertySectionTemplate");
...
static_assert(offsetof(FMovieSceneVectorPropertySectionTemplate, NumChannelsUsed) == 0x0002B8, "Member 'FMovieSceneVectorPropertySectionTemplate::NumChannelsUsed' has a wrong offset!");
static_assert(offsetof(FMovieSceneVectorPropertySectionTemplate, BlendType) == 0x0002BC, "Member 'FMovieSceneVectorPropertySectionTemplate::BlendType' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneIntegerPropertySectionTemplate) == 0x0000D0, "Wrong size on FMovieSceneIntegerPropertySectionTemplate");
...
static_assert(offsetof(FMovieSceneIntegerPropertySectionTemplate, BlendType) == 0x0000C8, "Member 'FMovieSceneIntegerPropertySectionTemplate::BlendType' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneEnumPropertySectionTemplate) == 0x0000D0, "Wrong size on FMovieSceneEnumPropertySectionTemplate");
...
static_assert(sizeof(FMovieSceneBytePropertySectionTemplate) == 0x0000D0, "Wrong size on FMovieSceneBytePropertySectionTemplate");
...
public:
	...
	class FName                                   RefOnDisconnected;                                 // 0x00C8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSkipAnimNotifiers;                                // 0x00D0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForceCustomMode;                                  // 0x00D1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D2[0x2];                                       // 0x00D2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         StartOffset;                                       // 0x00D4(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EndOffset;                                         // 0x00D8(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FMovieSceneSkeletalAnimationParams) == 0x0000E0, "Wrong size on FMovieSceneSkeletalAnimationParams");
...
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, RefOnDisconnected) == 0x0000C8, "Member 'FMovieSceneSkeletalAnimationParams::RefOnDisconnected' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, bSkipAnimNotifiers) == 0x0000D0, "Member 'FMovieSceneSkeletalAnimationParams::bSkipAnimNotifiers' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, bForceCustomMode) == 0x0000D1, "Member 'FMovieSceneSkeletalAnimationParams::bForceCustomMode' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, StartOffset) == 0x0000D4, "Member 'FMovieSceneSkeletalAnimationParams::StartOffset' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, EndOffset) == 0x0000D8, "Member 'FMovieSceneSkeletalAnimationParams::EndOffset' has a wrong offset!");
...
{
public:
	struct FFrameNumber                           SectionStartTime;                                  // 0x00E0(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                           SectionEndTime;                                    // 0x00E4(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FMovieSceneSkeletalAnimationSectionTemplateParameters) == 0x0000E8, "Wrong size on FMovieSceneSkeletalAnimationSectionTemplateParameters");
static_assert(offsetof(FMovieSceneSkeletalAnimationSectionTemplateParameters, SectionStartTime) == 0x0000E0, "Member 'FMovieSceneSkeletalAnimationSectionTemplateParameters::SectionStartTime' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationSectionTemplateParameters, SectionEndTime) == 0x0000E4, "Member 'FMovieSceneSkeletalAnimationSectionTemplateParameters::SectionEndTime' has a wrong offset!");
...
{
public:
	struct FMovieSceneSkeletalAnimationSectionTemplateParameters Params;                                            // 0x0020(0x00E8)(NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FMovieSceneSkeletalAnimationSectionTemplate) == 0x000108, "Wrong size on FMovieSceneSkeletalAnimationSectionTemplate");
