...
public:
	...
	uint8                                         Pad_7BA[0x6];                                      // 0x07BA(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNetDriverEOS) == 0x0007C0, "Wrong size on UNetDriverEOS");
static_assert(offsetof(UNetDriverEOS, bIsPassthrough) == 0x0007B8, "Member 'UNetDriverEOS::bIsPassthrough' has a wrong offset!");
static_assert(offsetof(UNetDriverEOS, bIsUsingP2PSockets) == 0x0007B9, "Member 'UNetDriverEOS::bIsUsingP2PSockets' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1B90[0x8];                                     // 0x1B90(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNetConnectionEOS) == 0x001B98, "Wrong size on UNetConnectionEOS");
