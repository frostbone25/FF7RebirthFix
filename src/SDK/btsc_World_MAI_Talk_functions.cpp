...
#include "btsc_World_MAI_Talk_classes.hpp"
#include "btsc_World_MAI_Talk_parameters.hpp"
...
void Abtsc_World_MAI_Talk_C::ExecuteUbergraph_btsc_World_MAI_Talk(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_World_MAI_Talk_C", "ExecuteUbergraph_btsc_World_MAI_Talk");

	Params::btsc_World_MAI_Talk_C_ExecuteUbergraph_btsc_World_MAI_Talk Parms{};
...
void Abtsc_World_MAI_Talk_C::OnTakeDamage(int32 Damage, const class FName& CauserCharaName, const class FName& DamagedCharaName, const class FName& AbilityId, bool bBind, bool bGuard, const class FName& hitBoneName, bool bAttributeHit, bool bResistHit, const class FName& DamageSourceID, EEndBattleAttributeType appendAttribute, float justHitRotYaw, const struct FVector& hitPosition, bool bHeal, bool bBurst, bool bLock)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_World_MAI_Talk_C", "OnTakeDamage");

	Params::btsc_World_MAI_Talk_C_OnTakeDamage Parms{};
...
void Abtsc_World_MAI_Talk_C::OnEntryBattleScene(const class FName& battleScenenBPName, const class FName& territoryID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_World_MAI_Talk_C", "OnEntryBattleScene");

	Params::btsc_World_MAI_Talk_C_OnEntryBattleScene Parms{};
