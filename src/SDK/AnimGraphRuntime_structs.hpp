...
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000A20, "Wrong size on FAnimSequencerInstanceProxy");
...
static_assert(sizeof(FAnimNode_PoseDriver) == 0x000138, "Wrong size on FAnimNode_PoseDriver");
...
public:
	...
	uint8                                         Pad_208[0x488];                                    // 0x0208(0x0488)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_RigidBody) == 0x000010, "Wrong alignment on FAnimNode_RigidBody");
static_assert(sizeof(FAnimNode_RigidBody) == 0x000690, "Wrong size on FAnimNode_RigidBody");
