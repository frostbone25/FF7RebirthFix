...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UNiagaraSimCache*                 InSimCache                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UNiagaraComponent::SetSimCache(class UNiagaraSimCache* InSimCache)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// class UNiagaraSimCache*                 ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UNiagaraParameterCollectionInstance::VfxSetMatrixParameter(const class FString& InVariableName, const struct FMatrix& InValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NiagaraParameterCollectionInstance", "VfxSetMatrixParameter");

	Params::NiagaraParameterCollectionInstance_VfxSetMatrixParameter Parms{};
