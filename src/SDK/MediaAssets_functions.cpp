...
void UMediaTexture::OnMediaOpened(const class FString& OpenedUrl)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MediaTexture", "OnMediaOpened");

	Params::MediaTexture_OnMediaOpened Parms{};
