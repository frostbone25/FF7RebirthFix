...
static_assert(sizeof(FVehicleAnimInstanceProxy) == 0x000790, "Wrong size on FVehicleAnimInstanceProxy");
...
public:
	...
	float                                         TorqueScale;                                       // 0x009C(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FVehicleEngineData, TorqueScale) == 0x00009C, "Member 'FVehicleEngineData::TorqueScale' has a wrong offset!");
