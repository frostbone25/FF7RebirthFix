...
static_assert(sizeof(NiagaraComponent_SetSimCache) == 0x000008, "Wrong size on NiagaraComponent_SetSimCache");
static_assert(offsetof(NiagaraComponent_SetSimCache, InSimCache) == 0x000000, "Member 'NiagaraComponent_SetSimCache::InSimCache' has a wrong offset!");
...
// Function Niagara.NiagaraParameterCollectionInstance.VfxSetMatrixParameter
// 0x0050 (0x0050 - 0x0000)
struct NiagaraParameterCollectionInstance_VfxSetMatrixParameter final
{
public:
	class FString                                 InVariableName;                                    // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMatrix                                InValue;                                           // 0x0010(0x0040)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(NiagaraParameterCollectionInstance_VfxSetMatrixParameter) == 0x000010, "Wrong alignment on NiagaraParameterCollectionInstance_VfxSetMatrixParameter");
static_assert(sizeof(NiagaraParameterCollectionInstance_VfxSetMatrixParameter) == 0x000050, "Wrong size on NiagaraParameterCollectionInstance_VfxSetMatrixParameter");
static_assert(offsetof(NiagaraParameterCollectionInstance_VfxSetMatrixParameter, InVariableName) == 0x000000, "Member 'NiagaraParameterCollectionInstance_VfxSetMatrixParameter::InVariableName' has a wrong offset!");
static_assert(offsetof(NiagaraParameterCollectionInstance_VfxSetMatrixParameter, InValue) == 0x000010, "Member 'NiagaraParameterCollectionInstance_VfxSetMatrixParameter::InValue' has a wrong offset!");
