...
#include "btsc_1200_GRASA_Grassland_swampmob_03_classes.hpp"
#include "btsc_1200_GRASA_Grassland_swampmob_03_parameters.hpp"
...
void Abtsc_1200_GRASA_Grassland_swampmob_03_C::ExecuteUbergraph_btsc_1200_GRASA_Grassland_swampmob_03(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_1200-GRASA_Grassland_swampmob_03_C", "ExecuteUbergraph_btsc_1200-GRASA_Grassland_swampmob_03");

	Params::btsc_1200_GRASA_Grassland_swampmob_03_C_ExecuteUbergraph_btsc_1200_GRASA_Grassland_swampmob_03 Parms{};
...
void Abtsc_1200_GRASA_Grassland_swampmob_03_C::OnTakeDamage(int32 Damage, const class FName& CauserCharaName, const class FName& DamagedCharaName, const class FName& AbilityId, bool bBind, bool bGuard, const class FName& hitBoneName, bool bAttributeHit, bool bResistHit, const class FName& DamageSourceID, EEndBattleAttributeType appendAttribute, float justHitRotYaw, const struct FVector& hitPosition, bool bHeal, bool bBurst, bool bLock)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_1200-GRASA_Grassland_swampmob_03_C", "OnTakeDamage");

	Params::btsc_1200_GRASA_Grassland_swampmob_03_C_OnTakeDamage Parms{};
...
void Abtsc_1200_GRASA_Grassland_swampmob_03_C::OnEntryBattleScene(const class FName& battleScenenBPName, const class FName& territoryID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("btsc_1200-GRASA_Grassland_swampmob_03_C", "OnEntryBattleScene");

	Params::btsc_1200_GRASA_Grassland_swampmob_03_C_OnEntryBattleScene Parms{};
