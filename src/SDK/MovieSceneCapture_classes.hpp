...
public:
	...
	bool                                          CaptureFramesAsHDR;                                // 0x0068(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          CaptureFramesAsNormalized;                         // 0x0069(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          CaptureFramesAsTonemapped;                         // 0x006A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6B[0x5];                                       // 0x006B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoftObjectPath                        PostProcessingMaterial;                            // 0x0070(0x0018)(Edit, BlueprintVisible, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DisableScreenPercentage;                           // 0x0088(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_89[0x7];                                       // 0x0089(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UMaterialInterface*                     PostProcessingMaterialPtr;                         // 0x0090(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCompositionGraphCaptureProtocol) == 0x0000B8, "Wrong size on UCompositionGraphCaptureProtocol");
...
static_assert(offsetof(UCompositionGraphCaptureProtocol, CaptureFramesAsHDR) == 0x000068, "Member 'UCompositionGraphCaptureProtocol::CaptureFramesAsHDR' has a wrong offset!");
static_assert(offsetof(UCompositionGraphCaptureProtocol, CaptureFramesAsNormalized) == 0x000069, "Member 'UCompositionGraphCaptureProtocol::CaptureFramesAsNormalized' has a wrong offset!");
static_assert(offsetof(UCompositionGraphCaptureProtocol, CaptureFramesAsTonemapped) == 0x00006A, "Member 'UCompositionGraphCaptureProtocol::CaptureFramesAsTonemapped' has a wrong offset!");
static_assert(offsetof(UCompositionGraphCaptureProtocol, PostProcessingMaterial) == 0x000070, "Member 'UCompositionGraphCaptureProtocol::PostProcessingMaterial' has a wrong offset!");
static_assert(offsetof(UCompositionGraphCaptureProtocol, DisableScreenPercentage) == 0x000088, "Member 'UCompositionGraphCaptureProtocol::DisableScreenPercentage' has a wrong offset!");
static_assert(offsetof(UCompositionGraphCaptureProtocol, PostProcessingMaterialPtr) == 0x000090, "Member 'UCompositionGraphCaptureProtocol::PostProcessingMaterialPtr' has a wrong offset!");
...
public:
	...
	struct FMovieSceneCaptureSettings             Settings;                                          // 0x0078(0x0098)(Edit, BlueprintVisible, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneCapture) == 0x000250, "Wrong size on UMovieSceneCapture");
...
static_assert(offsetof(ULevelCapture, bAutoStartCapture) == 0x000250, "Member 'ULevelCapture::bAutoStartCapture' has a wrong offset!");
static_assert(offsetof(ULevelCapture, PrerequisiteActorId) == 0x00025C, "Member 'ULevelCapture::PrerequisiteActorId' has a wrong offset!");
