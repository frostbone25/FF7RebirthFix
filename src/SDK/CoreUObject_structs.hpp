...
// ScriptStruct CoreUObject.TransientName
// 0x0008 (0x0008 - 0x0000)
struct FTransientName final
{
public:
	uint32                                        Hash;                                              // 0x0000(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ID;                                                // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FTransientName) == 0x000004, "Wrong alignment on FTransientName");
static_assert(sizeof(FTransientName) == 0x000008, "Wrong size on FTransientName");
static_assert(offsetof(FTransientName, Hash) == 0x000000, "Member 'FTransientName::Hash' has a wrong offset!");
static_assert(offsetof(FTransientName, ID) == 0x000004, "Member 'FTransientName::ID' has a wrong offset!");
