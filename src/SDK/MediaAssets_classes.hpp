...
{
public:
	bool                                          bHDR;                                              // 0x00E0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_E1[0x7];                                       // 0x00E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                MediaTextureImpl;                                  // 0x00E8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMediaTexture) == 0x0000F0, "Wrong size on UMediaTexture");
static_assert(offsetof(UMediaTexture, bHDR) == 0x0000E0, "Member 'UMediaTexture::bHDR' has a wrong offset!");
static_assert(offsetof(UMediaTexture, MediaTextureImpl) == 0x0000E8, "Member 'UMediaTexture::MediaTextureImpl' has a wrong offset!");
...
// Class MediaAssets.MediaPlayerInterface
// 0x0000 (0x0028 - 0x0028)
class IMediaPlayerInterface final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MediaPlayerInterface">();
	}
	static class IMediaPlayerInterface* GetDefaultObj()
	{
		return GetDefaultObjImpl<IMediaPlayerInterface>();
	}
};
static_assert(alignof(IMediaPlayerInterface) == 0x000008, "Wrong alignment on IMediaPlayerInterface");
static_assert(sizeof(IMediaPlayerInterface) == 0x000028, "Wrong size on IMediaPlayerInterface");
...
public:
	...
	uint8                                         Pad_6F8[0x1F8];                                    // 0x06F8(0x01F8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMediaSoundComponent) == 0x0008F0, "Wrong size on UMediaSoundComponent");
...
// Class MediaAssets.MediaTextureImpl
// 0x00E8 (0x0110 - 0x0028)
class UMediaTextureImpl final : public UObject
{
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	ETextureAddress                               AddressX;                                          // 0x0030(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETextureAddress                               AddressY;                                          // 0x0031(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AutoClear;                                         // 0x0032(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_33[0x1];                                       // 0x0033(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           ClearColor;                                        // 0x0034(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableGenMips;                                     // 0x0044(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         NumMips;                                           // 0x0045(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          NewStyleOutput;                                    // 0x0046(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMediaTextureOutputFormat                     OutputFormat;                                      // 0x0047(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CurrentAspectRatio;                                // 0x0048(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, TextExportTransient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMediaTextureOrientation                      CurrentOrientation;                                // 0x004C(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, TextExportTransient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4D[0xB];                                       // 0x004D(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	class UMediaPlayer*                           MediaPlayer;                                       // 0x0058(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_60[0xB0];                                      // 0x0060(0x00B0)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MediaTextureImpl">();
	}
	static class UMediaTextureImpl* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMediaTextureImpl>();
	}
};
static_assert(alignof(UMediaTextureImpl) == 0x000008, "Wrong alignment on UMediaTextureImpl");
static_assert(sizeof(UMediaTextureImpl) == 0x000110, "Wrong size on UMediaTextureImpl");
static_assert(offsetof(UMediaTextureImpl, AddressX) == 0x000030, "Member 'UMediaTextureImpl::AddressX' has a wrong offset!");
static_assert(offsetof(UMediaTextureImpl, AddressY) == 0x000031, "Member 'UMediaTextureImpl::AddressY' has a wrong offset!");
static_assert(offsetof(UMediaTextureImpl, AutoClear) == 0x000032, "Member 'UMediaTextureImpl::AutoClear' has a wrong offset!");
static_assert(offsetof(UMediaTextureImpl, ClearColor) == 0x000034, "Member 'UMediaTextureImpl::ClearColor' has a wrong offset!");
static_assert(offsetof(UMediaTextureImpl, EnableGenMips) == 0x000044, "Member 'UMediaTextureImpl::EnableGenMips' has a wrong offset!");
static_assert(offsetof(UMediaTextureImpl, NumMips) == 0x000045, "Member 'UMediaTextureImpl::NumMips' has a wrong offset!");
static_assert(offsetof(UMediaTextureImpl, NewStyleOutput) == 0x000046, "Member 'UMediaTextureImpl::NewStyleOutput' has a wrong offset!");
static_assert(offsetof(UMediaTextureImpl, OutputFormat) == 0x000047, "Member 'UMediaTextureImpl::OutputFormat' has a wrong offset!");
static_assert(offsetof(UMediaTextureImpl, CurrentAspectRatio) == 0x000048, "Member 'UMediaTextureImpl::CurrentAspectRatio' has a wrong offset!");
static_assert(offsetof(UMediaTextureImpl, CurrentOrientation) == 0x00004C, "Member 'UMediaTextureImpl::CurrentOrientation' has a wrong offset!");
static_assert(offsetof(UMediaTextureImpl, MediaPlayer) == 0x000058, "Member 'UMediaTextureImpl::MediaPlayer' has a wrong offset!");

// Class MediaAssets.MediaTextureImplInterface
// 0x0000 (0x0028 - 0x0028)
class IMediaTextureImplInterface final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MediaTextureImplInterface">();
	}
	static class IMediaTextureImplInterface* GetDefaultObj()
	{
		return GetDefaultObjImpl<IMediaTextureImplInterface>();
	}
};
static_assert(alignof(IMediaTextureImplInterface) == 0x000008, "Wrong alignment on IMediaTextureImplInterface");
static_assert(sizeof(IMediaTextureImplInterface) == 0x000028, "Wrong size on IMediaTextureImplInterface");
