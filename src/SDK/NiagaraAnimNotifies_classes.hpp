...
{
public:
	bool                                          bEnableNormalizedNotifyProgress;                   // 0x0060(0x0001)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x3];                                       // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   NotifyProgressUserParameter;                       // 0x0064(0x0008)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6C[0x4];                                       // 0x006C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FCurveParameterPair>            AnimCurves;                                        // 0x0070(0x0010)(Edit, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAnimNotifyState_TimedNiagaraEffectAdvanced) == 0x0000D0, "Wrong size on UAnimNotifyState_TimedNiagaraEffectAdvanced");
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffectAdvanced, bEnableNormalizedNotifyProgress) == 0x000060, "Member 'UAnimNotifyState_TimedNiagaraEffectAdvanced::bEnableNormalizedNotifyProgress' has a wrong offset!");
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffectAdvanced, NotifyProgressUserParameter) == 0x000064, "Member 'UAnimNotifyState_TimedNiagaraEffectAdvanced::NotifyProgressUserParameter' has a wrong offset!");
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffectAdvanced, AnimCurves) == 0x000070, "Member 'UAnimNotifyState_TimedNiagaraEffectAdvanced::AnimCurves' has a wrong offset!");
