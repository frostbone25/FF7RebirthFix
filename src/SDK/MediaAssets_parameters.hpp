...
// Function MediaAssets.MediaTexture.OnMediaOpened
// 0x0010 (0x0010 - 0x0000)
struct MediaTexture_OnMediaOpened final
{
public:
	class FString                                 OpenedUrl;                                         // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MediaTexture_OnMediaOpened) == 0x000008, "Wrong alignment on MediaTexture_OnMediaOpened");
static_assert(sizeof(MediaTexture_OnMediaOpened) == 0x000010, "Wrong size on MediaTexture_OnMediaOpened");
static_assert(offsetof(MediaTexture_OnMediaOpened, OpenedUrl) == 0x000000, "Member 'MediaTexture_OnMediaOpened::OpenedUrl' has a wrong offset!");
