...
{
public:
	struct FMaterialQualityOverrides              QualityOverrides;                                  // 0x0028(0x0009)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UShaderPlatformQualitySettings) == 0x000048, "Wrong size on UShaderPlatformQualitySettings");
