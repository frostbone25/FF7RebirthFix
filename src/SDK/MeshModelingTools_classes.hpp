...
static_assert(sizeof(UBakeMeshAttributeMapsToolProperties) == 0x000098, "Wrong size on UBakeMeshAttributeMapsToolProperties");
...
static_assert(offsetof(UBakeMeshAttributeMapsToolProperties, UVLayer) == 0x000068, "Member 'UBakeMeshAttributeMapsToolProperties::UVLayer' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsToolProperties, UVLayerNamesList) == 0x000078, "Member 'UBakeMeshAttributeMapsToolProperties::UVLayerNamesList' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsToolProperties, bUseWorldSpace) == 0x000088, "Member 'UBakeMeshAttributeMapsToolProperties::bUseWorldSpace' has a wrong offset!");
...
{
public:
	int32                                         OcclusionRays;                                     // 0x0060(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBakedOcclusionMapToolProperties) == 0x000078, "Wrong size on UBakedOcclusionMapToolProperties");
static_assert(offsetof(UBakedOcclusionMapToolProperties, OcclusionRays) == 0x000060, "Member 'UBakedOcclusionMapToolProperties::OcclusionRays' has a wrong offset!");
static_assert(offsetof(UBakedOcclusionMapToolProperties, MaxDistance) == 0x000064, "Member 'UBakedOcclusionMapToolProperties::MaxDistance' has a wrong offset!");
static_assert(offsetof(UBakedOcclusionMapToolProperties, bGaussianBlur) == 0x000068, "Member 'UBakedOcclusionMapToolProperties::bGaussianBlur' has a wrong offset!");
static_assert(offsetof(UBakedOcclusionMapToolProperties, BlurRadius) == 0x00006C, "Member 'UBakedOcclusionMapToolProperties::BlurRadius' has a wrong offset!");
static_assert(offsetof(UBakedOcclusionMapToolProperties, BiasAngle) == 0x000070, "Member 'UBakedOcclusionMapToolProperties::BiasAngle' has a wrong offset!");
...
static_assert(sizeof(UBakeMeshAttributeMapsTool) == 0x0004D0, "Wrong size on UBakeMeshAttributeMapsTool");
...
static_assert(offsetof(UBakeMeshAttributeMapsTool, CachedNormalMap) == 0x000430, "Member 'UBakeMeshAttributeMapsTool::CachedNormalMap' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsTool, CachedOcclusionMap) == 0x000450, "Member 'UBakeMeshAttributeMapsTool::CachedOcclusionMap' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsTool, CachedCurvatureMap) == 0x000480, "Member 'UBakeMeshAttributeMapsTool::CachedCurvatureMap' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsTool, CachedMeshPropertyMap) == 0x000498, "Member 'UBakeMeshAttributeMapsTool::CachedMeshPropertyMap' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsTool, CachedTexture2DImageMap) == 0x0004B0, "Member 'UBakeMeshAttributeMapsTool::CachedTexture2DImageMap' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsTool, EmptyNormalMap) == 0x0004B8, "Member 'UBakeMeshAttributeMapsTool::EmptyNormalMap' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsTool, EmptyColorMapBlack) == 0x0004C0, "Member 'UBakeMeshAttributeMapsTool::EmptyColorMapBlack' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsTool, EmptyColorMapWhite) == 0x0004C8, "Member 'UBakeMeshAttributeMapsTool::EmptyColorMapWhite' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_D8[0x1218];                                    // 0x00D8(0x1218)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDeformMeshPolygonsTool) == 0x0012F0, "Wrong size on UDeformMeshPolygonsTool");
...
static_assert(sizeof(UDynamicMeshBrushTool) == 0x000200, "Wrong size on UDynamicMeshBrushTool");
static_assert(offsetof(UDynamicMeshBrushTool, PreviewMesh) == 0x0001C0, "Member 'UDynamicMeshBrushTool::PreviewMesh' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_158[0xAF8];                                    // 0x0158(0x0AF8)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDynamicMeshSculptTool) == 0x000C70, "Wrong size on UDynamicMeshSculptTool");
...
static_assert(offsetof(UDynamicMeshSculptTool, PlaneTransformGizmo) == 0x000C50, "Member 'UDynamicMeshSculptTool::PlaneTransformGizmo' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, PlaneTransformProxy) == 0x000C58, "Member 'UDynamicMeshSculptTool::PlaneTransformProxy' has a wrong offset!");
...
static_assert(offsetof(UPolyEditCommonProperties, bSelectEdgeLoops) == 0x000061, "Member 'UPolyEditCommonProperties::bSelectEdgeLoops' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_F8[0x278];                                     // 0x00F8(0x0278)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEditUVIslandsTool) == 0x000370, "Wrong size on UEditUVIslandsTool");
...
public:
	...
	uint8                                         Pad_208[0x428];                                    // 0x0208(0x0428)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshAttributePaintTool) == 0x000630, "Wrong size on UMeshAttributePaintTool");
static_assert(offsetof(UMeshAttributePaintTool, AttribProps) == 0x000200, "Member 'UMeshAttributePaintTool::AttribProps' has a wrong offset!");
...
public:
	...
	struct FLinearColor                           BrushColor;                                        // 0x007C(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8C[0x4];                                       // 0x008C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UTexture2D*                             Image;                                             // 0x0090(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMeshEditingViewProperties) == 0x000098, "Wrong size on UMeshEditingViewProperties");
...
static_assert(offsetof(UMeshEditingViewProperties, BrushColor) == 0x00007C, "Member 'UMeshEditingViewProperties::BrushColor' has a wrong offset!");
static_assert(offsetof(UMeshEditingViewProperties, Image) == 0x000090, "Member 'UMeshEditingViewProperties::Image' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_230[0x278];                                    // 0x0230(0x0278)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshSelectionTool) == 0x0004A8, "Wrong size on UMeshSelectionTool");
static_assert(offsetof(UMeshSelectionTool, SelectionProps) == 0x000200, "Member 'UMeshSelectionTool::SelectionProps' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, SelectionActions) == 0x000208, "Member 'UMeshSelectionTool::SelectionActions' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, EditActions) == 0x000210, "Member 'UMeshSelectionTool::EditActions' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, Selection) == 0x000218, "Member 'UMeshSelectionTool::Selection' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, SpawnedActors) == 0x000220, "Member 'UMeshSelectionTool::SpawnedActors' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_210[0xD0];                                     // 0x0210(0x00D0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USeamSculptTool) == 0x0002E0, "Wrong size on USeamSculptTool");
static_assert(offsetof(USeamSculptTool, Settings) == 0x000200, "Member 'USeamSculptTool::Settings' has a wrong offset!");
static_assert(offsetof(USeamSculptTool, PreviewGeom) == 0x000208, "Member 'USeamSculptTool::PreviewGeom' has a wrong offset!");
