...
public:
	...
	float                                         RaiseMassToPower;                                  // 0x0040(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPhysicalSurface                              SurfaceType;                                       // 0x0044(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_45[0x1B];                                      // 0x0045(0x001B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPhysicalMaterial) == 0x000060, "Wrong size on UPhysicalMaterial");
...
static_assert(offsetof(UPhysicalMaterial, RaiseMassToPower) == 0x000040, "Member 'UPhysicalMaterial::RaiseMassToPower' has a wrong offset!");
static_assert(offsetof(UPhysicalMaterial, SurfaceType) == 0x000044, "Member 'UPhysicalMaterial::SurfaceType' has a wrong offset!");
