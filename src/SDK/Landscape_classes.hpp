...
public:
	...
	struct FBodyInstance                          BodyInstance;                                      // 0x03E0(0x0170)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	...
	TMap<class UTexture2D*, class ULandscapeWeightmapUsage*> WeightmapUsageMap;                                 // 0x0568(0x0050)(Transient, NativeAccessSpecifierPublic)
...
static_assert(offsetof(ALandscapeProxy, WeightmapUsageMap) == 0x000568, "Member 'ALandscapeProxy::WeightmapUsageMap' has a wrong offset!");
...
{
public:
	TArray<struct FLandscapeMaterialTextureStreamingInfo> TextureStreamingInfo;                              // 0x0400(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         bIsLayerThumbnail : 1;                             // 0x0410(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDisableTessellation : 1;                          // 0x0410(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bMobile : 1;                                       // 0x0410(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEditorToolUsage : 1;                              // 0x0410(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(ULandscapeMaterialInstanceConstant) == 0x000418, "Wrong size on ULandscapeMaterialInstanceConstant");
static_assert(offsetof(ULandscapeMaterialInstanceConstant, TextureStreamingInfo) == 0x000400, "Member 'ULandscapeMaterialInstanceConstant::TextureStreamingInfo' has a wrong offset!");
...
static_assert(sizeof(ULandscapeSubsystem) == 0x000048, "Wrong size on ULandscapeSubsystem");
