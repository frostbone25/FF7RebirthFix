...
// Enum AIModule.EEndEnvQueryPriority
// NumValues: 0x0004
enum class EEndEnvQueryPriority : uint8
{
	Top                                      = 0,
	High                                     = 1,
	Default                                  = 2,
...
static_assert(sizeof(FEnvQueryRequest) == 0x000070, "Wrong size on FEnvQueryRequest");
...
public:
	...
	EEndEnvQueryPriority                          Priority;                                          // 0x0048(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FEQSParametrizedQueryExecutionRequest, Priority) == 0x000048, "Member 'FEQSParametrizedQueryExecutionRequest::Priority' has a wrong offset!");
...
public:
	...
	ENavAgentPropertyCategory                     NavAgentPropertyCategory;                          // 0x0030(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FEnvTraceData, NavAgentPropertyCategory) == 0x000030, "Member 'FEnvTraceData::NavAgentPropertyCategory' has a wrong offset!");
